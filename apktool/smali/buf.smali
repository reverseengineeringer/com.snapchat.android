...
.method private constructor <init>(Ljava/security/Provider$Service;Lbtl;Lbsw;)V
    .locals 7
    ...
    .line 50
    iput-object p2, p0, Lbuf;->b:Lbtl;

    .line 51
    iput-object p3, p0, Lbuf;->c:Lbsw;

    .line 52
    iput-object p1, p0, Lbuf;->d:Ljava/security/Provider$Service;

    .line 53
    return-void
.end method

.method private static a(Ljava/security/Provider$Service;Lbtl;Lbsw;)Lbuf;
    .locals 5
    ...
    invoke-direct {v0, p0, p1, p2}, Lbuf;-><init>(Ljava/security/Provider$Service;Lbtl;Lbsw;)V
...
.method public static a(Lbtl;Lbsw;)Z
    .locals 5
    ...
    .line 107
    :cond_1
    invoke-static {}, Lbuf;->a()Ljava/security/Provider;
    ...
    .line 115
    :goto_1
    sget-object v3, Lbuf;->a:[Ljava/lang/String;
    ...
    instance-of v4, v3, Lbuf;

    if-nez v4, :cond_2

    .line 120
    invoke-static {v3, p0, p1}, Lbuf;->a(Ljava/security/Provider$Service;Lbtl;Lbsw;)Lbuf;
...
.method private b()Z
    ...
    .line 159
    invoke-virtual {p0}, Lbuf;->getProvider()Ljava/security/Provider;
    ...
    .line 176
    invoke-virtual {p0}, Lbuf;->getClassName()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lbuf;->getType()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lbuf;->getAlgorithm()Ljava/lang/String;
...
.method public final newInstance(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v3, p0, Lbuf;->b:Lbtl;

    iget-object v4, p0, Lbuf;->c:Lbsw;

    invoke-static {v1, v3, v4}, Lbug;->a(Ljavax/net/ssl/SSLContextSpi;Lbtl;Lbsw;)Lbug;
    :try_end_0
