...
# direct methods
.method public static a(Lbhd;)Lcom/snapchat/android/model/chat/ChatConversation;
    .locals 7
    ...
    invoke-virtual {v0, v2, p0, v3, v3}, Lakc;->a(Lcom/snapchat/android/model/chat/ChatConversation;Lbhd;ZZ)V
    ...
    .line 68
    const-string v0, "ServerChatConversationUtils"
    ...
    iget-object v5, v2, Lcom/snapchat/android/model/chat/ChatConversation;->mId:Ljava/lang/String;
    ...
    invoke-virtual {v0, v2, v1}, Lyj;->a(Lcom/snapchat/android/model/chat/ChatConversation;Lbit$a;)V
...
.method public static a(Ljava/util/List;)Ljava/util/List;
    ...
    .line 80
    invoke-virtual {v0}, Lbhh;->c()Lbhf;

    move-result-object v5

    .line 83
    invoke-virtual {v5}, Lbhf;->b()Z
    ...
    .line 84
    sget-object v1, Laul$1;->$SwitchMap$com$snapchat$soju$android$MessageBody$Type:[I

    invoke-virtual {v5}, Lbhf;->a()Lbij;

    move-result-object v6

    invoke-virtual {v6}, Lbij;->d()Lbij$a;

    move-result-object v6

    invoke-virtual {v6}, Lbij$a;->ordinal()I
    ...
    invoke-direct {v1, v5}, Lakj;-><init>(Lbhf;)V

    .line 124
    :goto_1
    invoke-virtual {v0}, Lbhh;->g()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v1, v0}, Lakb;->d(Ljava/lang/String;)V
    ...
    invoke-direct {v1, v5}, Laki;-><init>(Lbhf;)V
    ...
    invoke-direct {v1, v5}, Lcom/snapchat/android/model/chat/ChatMedia;-><init>(Lbhf;)V
    ...
    invoke-direct {v1, v5}, Lakh;-><init>(Lbhf;)V
    ...
    invoke-direct {v1, v5}, Lakg;-><init>(Lbhf;)V
    ...
    .line 127
    invoke-virtual {v0}, Lbhh;->a()Lbhy;

    move-result-object v0

    invoke-static {v0}, Laut;->a(Lbhy;)Lcom/snapchat/android/model/Snap;
    ...
    .line 129
    invoke-virtual {v0}, Lbhh;->e()Lbhc;

    move-result-object v1

    invoke-static {v1}, Lcom/snapchat/android/model/CashTransaction$a;->a(Lbhc;)Lcom/snapchat/android/model/CashTransaction;
