...
.method public constructor <init>(Landroid/widget/ListView;)V
    ...
    .line 24
    iput-object p1, p0, Lyi;->a:Landroid/widget/ListView;
...
.method public static a(Lcom/snapchat/android/model/chat/ChatFeedItem;Lcom/snapchat/android/model/chat/ChatFeedItem;)Z
    ...
    invoke-interface {p0}, Lcom/snapchat/android/model/chat/ChatFeedItem;->am()Z
...
.method public final a()V
    ...
    .prologue
    .line 116
    iget-object v0, p0, Lyi;->a:Landroid/widget/ListView;
    ...
    .line 122
    invoke-virtual {v0}, Lafr$c;->a()V

    .line 123
    iget-object v4, v0, Lafr$c;->L:Landroid/view/View;

    if-eqz v4, :cond_0

    .line 124
    iget-object v0, v0, Lafr$c;->L:Landroid/view/View;
...
.method public final a(Lafr$c;F)V
    .locals 12
    .param p1    # Lafr$c;
        .annotation build Lcgb;
        .end annotation
    ...
    .line 39
    iget-object v0, p1, Lafr$c;->C:Landroid/view/ViewGroup;
    ...
    .line 40
    iget-object v1, p1, Lafr$c;->y:Lcom/snapchat/android/ui/ImageResourceView;
    ...
    .line 41
    iget v2, p1, Lafr$c;->F:I

    if-nez v2, :cond_0

    iget v2, p1, Lafr$c;->G:I

    if-nez v2, :cond_0

    .line 42
    iget-object v2, p1, Lafr$c;->C:Landroid/view/ViewGroup;

    invoke-virtual {v2}, Landroid/view/ViewGroup;->getWidth()I

    move-result v2

    iput v2, p1, Lafr$c;->F:I
    ...
    iput v2, p1, Lafr$c;->G:I

    .line 45
    :cond_0
    iget v2, p1, Lafr$c;->H:I

    if-nez v2, :cond_1

    iget v2, p1, Lafr$c;->I:I
    ...
    iput v2, p1, Lafr$c;->I:I

    .line 50
    :cond_1
    iget v2, p0, Lyi;->b:I

    iget v3, p1, Lafr$c;->F:I
    ...
    .line 60
    iget-object v7, p1, Lafr$c;->C:Landroid/view/ViewGroup;
    ...
    .line 75
    :cond_3
    iget-object v1, p1, Lafr$c;->C:Landroid/view/ViewGroup;
    ...
    .line 81
    :cond_5
    iget-object v1, p1, Lafr$c;->L:Landroid/view/View;
    ...
    iget v3, p1, Lafr$c;->I:I

    int-to-float v3, v3

    mul-float/2addr v1, v3

    iget v3, p1, Lafr$c;->H:I
