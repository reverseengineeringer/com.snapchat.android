...
.field private mInterface:Lom$b;
...
.method public constructor <init>(Lom$b;)V
    ...
    iput-object v0, p0, Lom;->mContext:Landroid/content/Context;

    .line 61
    iget-object v0, p0, Lom;->mContext:Landroid/content/Context;
    ...
    .line 63
    :cond_1
    iput-object p1, p0, Lom;->mInterface:Lom$b;
    ...
    iput-object v0, p0, Lom;->mImages:Ljava/util/List;
...
.method protected final a(Laku;)V
    ...
    .line 156
    iget-object v0, p0, Lom;->mCaptchaId:Ljava/lang/String;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lom;->mImages:Ljava/util/List;
    ...
    .line 159
    iget-object v0, v0, Lom$a;->mBitmap:Landroid/graphics/Bitmap;
    ...
    .line 161
    :cond_0
    iget-object v0, p0, Lom;->mInterface:Lom$b;

    iget-object v2, p0, Lom;->mCaptchaId:Ljava/lang/String;

    invoke-interface {v0, v2, v1}, Lom$b;->a(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-interface {v0}, Lom$b;->a()V

    goto :goto_1
.end method

.method public final a(Lblu;Lbmd;)V
    .locals 7
    ...
    .line 92
    invoke-virtual {p1}, Lblu;->a()Ljava/util/Set;
    ...
    invoke-static {v0, v2}, Laui;->c(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iput-object v0, p0, Lom;->mCaptchaId:Ljava/lang/String;
    ...
    invoke-virtual {p2}, Lbmd;->c()Ljava/io/InputStream;
    ...
    .line 137
    const-string v1, "GetCaptchaTask"
    ...
    new-instance v1, Lom$1;

    invoke-direct {v1, p0}, Lom$1;-><init>(Lom;)V
    ...
    :cond_5
    :try_start_3
    iget-object v3, p0, Lom;->mContext:Landroid/content/Context;

    invoke-virtual {v2}, Ljava/io/ByteArrayOutputStream;->toByteArray()[B

    move-result-object v2

    invoke-static {v3, v2}, Laur;->a(Landroid/content/Context;[B)Landroid/graphics/Bitmap;

    move-result-object v2

    .line 131
    iget-object v3, p0, Lom;->mImages:Ljava/util/List;

    new-instance v4, Lom$a;

    invoke-direct {v4, p0, v0, v2}, Lom$a;-><init>(Lom;Ljava/lang/String;Landroid/graphics/Bitmap;)V
...
.method protected final synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lom;->a(Laku;)V
