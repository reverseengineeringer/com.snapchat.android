...
.method public final a()Ljava/util/Map;
    ...
    .line 104
    iget-object v1, p0, Lhc;->adIndexCount:Ljava/lang/Long;

    if-eqz v1, :cond_0

    const-string v1, "ad_index_count"

    iget-object v2, p0, Lhc;->adIndexCount:Ljava/lang/Long;

    invoke-interface {v0, v1, v2}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 105
    :cond_0
    iget-object v1, p0, Lhc;->adIndexPos:Ljava/lang/Long;

    if-eqz v1, :cond_1

    const-string v1, "ad_index_pos"

    iget-object v2, p0, Lhc;->adIndexPos:Ljava/lang/Long;

    invoke-interface {v0, v1, v2}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 106
    :cond_1
    iget-object v1, p0, Lhc;->additionalInfo:Lfz;

    if-eqz v1, :cond_2

    const-string v1, "additional_info"

    iget-object v2, p0, Lhc;->additionalInfo:Lfz;

    invoke-interface {v0, v1, v2}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 107
    :cond_2
    iget-object v1, p0, Lhc;->adsnapId:Ljava/lang/String;

    if-eqz v1, :cond_3

    const-string v1, "adsnap_id"

    iget-object v2, p0, Lhc;->adsnapId:Ljava/lang/String;
    ...
    .line 109
    :cond_4
    iget-object v1, p0, Lhc;->errorInfo:Ljava/lang/String;

    if-eqz v1, :cond_5

    const-string v1, "error_info"

    iget-object v2, p0, Lhc;->errorInfo:Ljava/lang/String;
    ...
    .line 113
    :cond_8
    iget-object v1, p0, Lhc;->source:Llv;

    if-eqz v1, :cond_9

    const-string v1, "source"

    iget-object v2, p0, Lhc;->source:Llv;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, p1, Lhc;->adIndexCount:Ljava/lang/Long;
    ...
    :cond_6
    iget-object v2, p1, Lhc;->adIndexCount:Ljava/lang/Long;
    ...
    iget-object v3, p1, Lhc;->adIndexPos:Ljava/lang/Long;
    ...
    :cond_9
    iget-object v2, p1, Lhc;->adIndexPos:Ljava/lang/Long;
    ...
    iget-object v3, p1, Lhc;->additionalInfo:Lfz;
    ...
    :cond_c
    iget-object v2, p1, Lhc;->additionalInfo:Lfz;
    ...
    iget-object v3, p1, Lhc;->adsnapId:Ljava/lang/String;
    ...
    :cond_f
    iget-object v2, p1, Lhc;->adsnapId:Ljava/lang/String;
    ...
    iget-object v3, p1, Lhc;->errorInfo:Ljava/lang/String;
    ...
    :cond_15
    iget-object v2, p1, Lhc;->errorInfo:Ljava/lang/String;
    ...
    iget-object v3, p1, Lhc;->source:Llv;
    ...
    :cond_20
    iget-object v2, p1, Lhc;->source:Llv;
...
.method public final hashCode()I
    ...
    iget-object v0, p0, Lhc;->adIndexCount:Ljava/lang/Long;
    ...
    iget-object v0, p0, Lhc;->adIndexPos:Ljava/lang/Long;
    ...
    iget-object v0, p0, Lhc;->additionalInfo:Lfz;
    ...
    iget-object v0, p0, Lhc;->adsnapId:Ljava/lang/String;
    ...
    iget-object v0, p0, Lhc;->errorInfo:Ljava/lang/String;
