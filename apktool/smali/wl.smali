...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/widget/RelativeLayout;Lcom/snapchat/android/camera/cameradecor/CameraDecor$CameraDecorInterface;Lbfe;)V
    .locals 11
    ...
    .line 45
    iput-object p4, p0, Lwl;->n:Lbfe;

    .line 46
    iget-object v1, p0, Lwl;->g:Landroid/widget/TextView;

    iput-object v1, p0, Lwl;->o:Landroid/widget/TextView;

    .line 48
    iget-object v1, p0, Lwl;->f:Landroid/widget/TextView;
    ...
    new-instance v2, Lwl$1;

    invoke-direct {v2, p0}, Lwl$1;-><init>(Lwl;)V
    ...
    .line 59
    iget-object v0, p0, Lwl;->o:Landroid/widget/TextView;
    ...
    new-instance v1, Lwl$2;

    invoke-direct {v1, p0}, Lwl$2;-><init>(Lwl;)V

    invoke-virtual {v0, v1}, Landroid/widget/TextView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 75
    iget-boolean v0, p4, Lbfe;->mDuringPresence:Z

    iput-boolean v0, p0, Lwl;->p:Z

    .line 77
    invoke-virtual {p0}, Lwl;->a()V
    ...
    invoke-static {v2, v2, v3}, Lavp;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, v2}, Lwl;->a(Landroid/content/Context;I)Landroid/graphics/Bitmap;
    ...
    invoke-static {v6, p1}, Lawf;->a(FLandroid/content/Context;)F
    ...
    .line 61
    :cond_2
    iget-object v1, p0, Lwl;->o:Landroid/widget/TextView;
...
.method private static a(Landroid/content/Context;I)Landroid/graphics/Bitmap;
    ...
    .line 167
    invoke-static {v0}, Lavp;->a(Ljava/lang/String;)[B
    :try_end_1
    ...
    :cond_3
    :try_start_2
    invoke-static {p0, v0}, Lavp;->a(Landroid/content/Context;[B)Landroid/graphics/Bitmap;
    :try_end_2
...
.method public final f()Z
    ...
    .line 90
    iget-object v0, p0, Lwl;->a:Lcom/snapchat/android/camera/cameradecor/CameraDecor$CameraDecorInterface;

    iget-object v1, p0, Lwl;->n:Lbfe;

    iget v1, v1, Lbfe;->mOriginatingFragment:I
    ...
    invoke-direct {v1, v3, v2}, Lbbs;-><init>(ZZ)V
