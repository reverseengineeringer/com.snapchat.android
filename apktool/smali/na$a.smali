...
# instance fields
.field private mAdPlacement:Lnc;

.field private mAdResponse:Lnf;

.field private mAdTransformListener:Lne;
...
# direct methods
.method constructor <init>(Lna;Lnc;Lne;Lcom/google/android/gms/ads/doubleclick/PublisherAdView;)V
    .locals 1
    .param p2    # Lnc;
    ...
    .prologue
    .line 380
    iput-object p1, p0, Lna$a;->this$0:Lna;
    ...
    iput-boolean v0, p0, Lna$a;->mShouldRecordImpressionWithAdResponse:Z
    ...
    iput-object v0, p0, Lna$a;->mImpressionUrls:Ljava/util/List;

    .line 381
    iput-object p2, p0, Lna$a;->mAdPlacement:Lnc;

    .line 382
    iput-object p3, p0, Lna$a;->mAdTransformListener:Lne;

    .line 383
    iput-object p4, p0, Lna$a;->mAdView:Lcom/google/android/gms/ads/doubleclick/PublisherAdView;

    .line 384
    return-void
.end method

.method static synthetic a(Lna$a;)Lnf;
    .locals 1

    .prologue
    .line 368
    iget-object v0, p0, Lna$a;->mAdResponse:Lnf;
...
.method protected final a()V
    ...
    .line 528
    iget-object v2, p0, Lna$a;->mImpressionUrls:Ljava/util/List;
    ...
    .line 529
    iget-object v0, p0, Lna$a;->mImpressionUrls:Ljava/util/List;
    ...
    .line 530
    iget-object v2, p0, Lna$a;->this$0:Lna;

    invoke-virtual {v2, v0}, Lna;->a(Ljava/lang/String;)V
    ...
    .line 532
    :cond_1
    iget-object v0, p0, Lna$a;->this$0:Lna;

    iget-object v1, p0, Lna$a;->mAdPlacement:Lnc;

    invoke-virtual {v0, v1}, Lna;->d(Lnc;)V
    ...
    .line 533
    :cond_2
    iget-object v2, p0, Lna$a;->mCustomRenderedAd:Lcom/google/android/gms/ads/doubleclick/CustomRenderedAd;
    ...
    .line 534
    iget-object v0, p0, Lna$a;->mCustomRenderedAd:Lcom/google/android/gms/ads/doubleclick/CustomRenderedAd;
    ...
    .line 537
    :cond_4
    iput-boolean v1, p0, Lna$a;->mShouldRecordImpressionWithAdResponse:Z
...
.method protected final a(Lcom/snapchat/android/ads/AdRequestError;Landroid/os/Bundle;)V
    ...
    .line 510
    :cond_0
    iget-object v0, p0, Lna$a;->mAdTransformListener:Lne;
    ...
    iput-object p1, v0, Lnf$a;->mAdRequestError:Lcom/snapchat/android/ads/AdRequestError;

    iput-object p2, v0, Lnf$a;->mAdResponseFieldBundle:Landroid/os/Bundle;

    invoke-virtual {v0}, Lnf$a;->a()Lnf;

    move-result-object v0

    .line 515
    iget-object v1, p0, Lna$a;->mAdTransformListener:Lne;
...
.method public final onAdFailedToLoad(I)V
    ...
    invoke-virtual {p0, v2, v0}, Lna$a;->a(Lcom/snapchat/android/ads/AdRequestError;Landroid/os/Bundle;)V
...
.method public final onCustomRenderedAdLoaded(Lcom/google/android/gms/ads/doubleclick/CustomRenderedAd;)V
    ...
    .line 393
    iput-object p1, p0, Lna$a;->mCustomRenderedAd:Lcom/google/android/gms/ads/doubleclick/CustomRenderedAd;
    ...
    invoke-virtual {p0, v0, v7}, Lna$a;->a(Lcom/snapchat/android/ads/AdRequestError;Landroid/os/Bundle;)V
    ...
    invoke-static {}, Lna;->b()Ljava/util/regex/Pattern;
    ...
    invoke-interface {v1, v0}, Lne;->a(Ljava/lang/String;)Landroid/os/Bundle;
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0

    move-result-object v0

    iget-object v1, p0, Lna$a;->mImpressionUrls:Ljava/util/List;
    ...
    invoke-virtual {p0, v1, v7}, Lna$a;->a(Lcom/snapchat/android/ads/AdRequestError;Landroid/os/Bundle;)V
    ...
    invoke-direct {v2}, Lnf$a;-><init>()V

    iput-object v1, v2, Lnf$a;->mTransformedUrl:Ljava/lang/String;

    iput-object v0, v2, Lnf$a;->mAdResponseFieldBundle:Landroid/os/Bundle;

    invoke-virtual {v2}, Lnf$a;->a()Lnf;

    move-result-object v0

    iput-object v0, p0, Lna$a;->mAdResponse:Lnf;

    const/4 v0, 0x2

    new-array v0, v0, [Ljava/lang/Object;

    iget-object v2, p0, Lna$a;->mAdPlacement:Lnc;
    ...
    iget-object v1, p0, Lna$a;->mAdResponse:Lnf;

    invoke-interface {v0, v1}, Lne;->a(Lnf;)V

    iput-object v7, p0, Lna$a;->mAdTransformListener:Lne;

    :cond_6
    iget-boolean v0, p0, Lna$a;->mShouldRecordImpressionWithAdResponse:Z
