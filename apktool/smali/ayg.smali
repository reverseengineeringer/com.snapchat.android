...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Layg;->mMap:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Layg;->mInitializationCountDownLatch:Ljava/util/concurrent/CountDownLatch;

    .line 89
    sget-object v0, Lauh;->SERIAL_EXECUTOR_FOR_SQL_WRITE_OPS:Ljava/util/concurrent/ExecutorService;

    iput-object v0, p0, Layg;->mExecutorService:Ljava/util/concurrent/ExecutorService;

    .line 90
    iput-boolean v1, p0, Layg;->mShouldRunTasksInBackground:Z
...
.method public final a(Layh;)Ljava/lang/String;
    ...
    .prologue
    .line 269
    iget-object v1, p0, Layg;->mMap:Ljava/util/HashMap;

    monitor-enter v1

    .line 270
    :try_start_0
    iget-object v0, p0, Layg;->mMap:Ljava/util/HashMap;
...
.method public final a()V
    ...
    .line 182
    :try_start_0
    iget-object v0, p0, Layg;->mInitializationCountDownLatch:Ljava/util/concurrent/CountDownLatch;
...
.method public final a(Layh;Ljava/lang/String;)V
    .locals 2
    .param p1    # Layh;
        .annotation build Lcgb;
        .end annotation
    ...
    iput-boolean v0, p0, Layg;->mBackingFileIsUpToDate:Z
...
.method public final a(Ljava/io/File;Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v1, v6}, Laye;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Layg;->b(Landroid/content/Context;)Ljavax/crypto/spec/SecretKeySpec;
    ...
    iget-object v1, v1, Layh;->mKey:Ljava/lang/String;
    ...
    sget-object v12, Layj;->CREDIT_CARD_TOKEN:Layh;
    ...
    invoke-virtual {p0, v12, v1}, Layg;->a(Layh;Ljava/lang/String;)V
    ...
    sget-object v12, Layj;->SQ_AUTH_TOKEN:Layh;

    iget-object v12, v12, Layh;->mKey:Ljava/lang/String;
    ...
    invoke-virtual {p0, v1, v0}, Layg;->a(Layh;Ljava/lang/String;)V
    :try_end_2
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_2

    :cond_3
    invoke-static {v5}, Lbfo;->a(Ljava/io/Closeable;)V

    invoke-static {v7}, Lbfo;->a(Ljava/io/Closeable;)V
    ...
    :goto_4
    :try_start_3
    const-string v7, "SlightlySecurePreferences"
    ...
    invoke-direct {v0, v1, p2}, Laye;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final b()Z
    ...
    .line 281
    iget-boolean v2, p0, Layg;->mShouldRunTasksInBackground:Z
    ...
    .line 287
    iget-boolean v2, p0, Layg;->mBackingFileIsUpToDate:Z
    ...
    invoke-static {v4}, Layg;->a(Landroid/content/Context;)Ljavax/crypto/spec/SecretKeySpec;
    ...
    .line 314
    :try_start_3
    iget-object v3, p0, Layg;->mMap:Ljava/util/HashMap;
    ...
    .line 315
    :try_start_4
    new-instance v5, Layg$2;

    invoke-direct {v5, p0}, Layg$2;-><init>(Layg;)V

    invoke-virtual {v5}, Layg$2;->getType()Ljava/lang/reflect/Type;
    ...
    iget-object v7, p0, Layg;->mMap:Ljava/util/HashMap;
    ...
    .line 329
    iput-boolean v1, p0, Layg;->mBackingFileIsEmpty:Z
...
.method public final c()V
    ...
    .line 431
    iget-object v2, p0, Layg;->mMap:Ljava/util/HashMap;
    ...
    iget-object v0, v0, Layh;->mType:Lcom/snapchat/android/util/crypto/SlightlySecurePreferencesKeyType;
    ...
    .line 442
    iget-boolean v0, p0, Layg;->mBackingFileIsUpToDate:Z

    if-nez v0, :cond_3

    .line 443
    iget-object v0, p0, Layg;->mExecutorService:Ljava/util/concurrent/ExecutorService;

    new-instance v1, Layg$3;

    invoke-direct {v1, p0}, Layg$3;-><init>(Layg;)V
...
.method public final d()V
    ...
    .line 475
    iget-boolean v0, p0, Layg;->mBackingFileIsEmpty:Z
    ...
    new-instance v1, Layg$4;

    invoke-direct {v1, p0}, Layg$4;-><init>(Layg;)V
...
.method protected final e()V
    ...
    .prologue
    .line 501
    iget-boolean v0, p0, Layg;->mShouldRunTasksInBackground:Z
    ...
    invoke-virtual {p0, v0, v1}, Layg;->a(Ljava/io/File;Ljava/lang/String;)Z

    .line 514
    const/4 v0, 0x1

    iput-boolean v0, p0, Layg;->mBackingFileIsEmpty:Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
