...
# instance fields
.field private zzED:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map",
            "<",
...
.field zzEE:Lcom/google/android/gms/analytics/ecommerce/ProductAction;

.field zzEF:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map",
            "<",
...
.method protected constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzED:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzEF:Ljava/util/Map;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzEG:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzEH:Ljava/util/List;
...
.method public addImpression(Lcom/google/android/gms/analytics/ecommerce/Product;Ljava/lang/String;)Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;
    ...
    :cond_1
    iget-object v0, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzEF:Ljava/util/Map;
...
.method public addProduct(Lcom/google/android/gms/analytics/ecommerce/Product;)Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzEH:Ljava/util/List;
...
.method public addPromotion(Lcom/google/android/gms/analytics/ecommerce/Promotion;)Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzEG:Ljava/util/List;
...
.method public build()Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzED:Ljava/util/Map;

    invoke-direct {v5, v0}, Ljava/util/HashMap;-><init>(Ljava/util/Map;)V

    iget-object v0, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzEE:Lcom/google/android/gms/analytics/ecommerce/ProductAction;
    ...
    invoke-static {v1}, Lcom/google/android/gms/analytics/zzs;->zzH(I)Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v0, v4}, Lcom/google/android/gms/analytics/ecommerce/Promotion;->zzaw(Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-static {v1}, Lcom/google/android/gms/analytics/zzs;->zzG(I)Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v0, v4}, Lcom/google/android/gms/analytics/ecommerce/Product;->zzaw(Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-static {v3}, Lcom/google/android/gms/analytics/zzs;->zzJ(I)Ljava/lang/String;
    ...
    invoke-static {v4}, Lcom/google/android/gms/analytics/zzs;->zzI(I)Ljava/lang/String;
    ...
    invoke-virtual {v1, v9}, Lcom/google/android/gms/analytics/ecommerce/Product;->zzaw(Ljava/lang/String;)Ljava/util/Map;
...
.method public final set(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;
    ...
    sget-object v1, Lcom/google/android/gms/analytics/zzy$zza;->zzCV:Lcom/google/android/gms/analytics/zzy$zza;
...
.method public final setAll(Ljava/util/Map;)Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;
    ...
    sget-object v1, Lcom/google/android/gms/analytics/zzy$zza;->zzCW:Lcom/google/android/gms/analytics/zzy$zza;
...
.method public setCampaignParamsFromUrl(Ljava/lang/String;)Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;
    ...
    sget-object v1, Lcom/google/android/gms/analytics/zzy$zza;->zzCY:Lcom/google/android/gms/analytics/zzy$zza;

    invoke-virtual {v0, v1}, Lcom/google/android/gms/analytics/zzy;->zza(Lcom/google/android/gms/analytics/zzy$zza;)V

    invoke-static {p1}, Lcom/google/android/gms/analytics/zzan;->zzau(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {v0}, Lcom/google/android/gms/analytics/zzan;->zzat(Ljava/lang/String;)Ljava/util/Map;
...
.method public setCustomDimension(ILjava/lang/String;)Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;
    ...
    invoke-static {p1}, Lcom/google/android/gms/analytics/zzs;->zzE(I)Ljava/lang/String;
...
.method public setCustomMetric(IF)Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;
    ...
    invoke-static {p1}, Lcom/google/android/gms/analytics/zzs;->zzF(I)Ljava/lang/String;
...
.method public setProductAction(Lcom/google/android/gms/analytics/ecommerce/ProductAction;)Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;
    ...
    iput-object p1, p0, Lcom/google/android/gms/analytics/HitBuilders$HitBuilder;->zzEE:Lcom/google/android/gms/analytics/ecommerce/ProductAction;
