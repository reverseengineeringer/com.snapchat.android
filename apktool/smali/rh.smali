...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lrh;->mCardStatus:Lcom/snapchat/android/api2/cash/square/data/CardStatus;

    .line 51
    const/4 v0, 0x0

    iput-boolean v0, p0, Lrh;->mUseDefaultGreen:Z
    ...
    invoke-interface {v0, p0}, Laza;->a(Lrh;)V
...
.method static synthetic a(Lcom/snapchat/android/api2/cash/square/data/ErrorType;)Lcom/snapchat/android/api2/cash/blockers/CardInputError;
    ...
    sget-object v0, Lrh$2;->$SwitchMap$com$snapchat$android$api2$cash$square$data$ErrorType:[I
...
.method static synthetic a(Lrh;)Lcom/snapchat/android/model/CashTransaction;
    .locals 1

    .prologue
    .line 34
    iget-object v0, p0, Lrh;->mTransactionContext:Lcom/snapchat/android/model/CashTransaction;

    return-object v0
.end method

.method private a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lqw;Z)V
    .locals 8
    ...
    invoke-direct {v7, p6}, Lrf;-><init>(Z)V

    .line 105
    new-instance v0, Lrh$1;
    ...
    invoke-direct/range {v0 .. v6}, Lrh$1;-><init>(Lrh;Lqw;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iput-object v0, v7, Lqv;->mListener:Lqv$a;

    .line 206
    const/4 v0, 0x0

    invoke-virtual {v7, v0}, Lqv;->a(Lcom/snapchat/android/model/CashTransaction;)V

    .line 207
    return-void
.end method

.method static synthetic a(Lrh;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lqw;)V
    .locals 7
    ...
    invoke-direct/range {v0 .. v6}, Lrh;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lqw;Z)V

    return-void
.end method

.method static synthetic a(Lrh;Ljava/util/List;)V
    .locals 1
    ...
    invoke-virtual {p0, p1, v0}, Lrh;->a(Ljava/util/List;Z)V

    return-void
.end method

.method static synthetic a(Lrh;Ljava/util/List;Z)V
    .locals 0

    .prologue
    .line 34
    invoke-virtual {p0, p1, p2}, Lrh;->b(Ljava/util/List;Z)V

    return-void
.end method

.method static synthetic b(Lrh;)Lcom/snapchat/android/model/CashTransaction;
    .locals 1
    ...
    iput-object v0, p0, Lrh;->mTransactionContext:Lcom/snapchat/android/model/CashTransaction;

    return-object v0
.end method

.method static synthetic c(Lrh;)Z
    .locals 1

    .prologue
    .line 34
    iget-boolean v0, p0, Lrh;->mRetriedFrom401:Z

    return v0
.end method

.method static synthetic d(Lrh;)Z
    .locals 1
    ...
    iput-boolean v0, p0, Lrh;->mRetriedFrom401:Z
...
.method public final a(Lcom/snapchat/android/model/CashTransaction;)V
    ...
    .line 65
    iput-object p1, p0, Lrh;->mTransactionContext:Lcom/snapchat/android/model/CashTransaction;

    .line 66
    iget-object v0, p0, Lrh;->mCardStatus:Lcom/snapchat/android/api2/cash/square/data/CardStatus;
    ...
    .line 68
    iget-object v0, p0, Lrh;->mCashCardManager:Lxr;
    ...
    invoke-virtual {p0, v0, v1}, Lrh;->a(Ljava/util/List;Z)V
    ...
    iget-boolean v3, p0, Lrh;->mUseDefaultGreen:Z
...
.method public final a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lqw;)V
    .locals 7
    .param p1    # Ljava/lang/String;
        .annotation build Lcgb;
        .end annotation
