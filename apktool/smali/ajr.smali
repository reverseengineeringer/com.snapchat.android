...
.field public final mClientCacheExpiration:Lcht;
...
.field public mCompositeBitmapExpiryTime:Lcht;
    .annotation runtime Lbxp;
    .end annotation
.end field
...
.field public final mGeofence:Lajq;
...
.method public constructor <init>(Lcom/snapchat/android/model/server/GeofilterResponse;)V
    ...
    iput-object v0, p0, Lajr;->mCompositeLock:Ljava/lang/Object;
    ...
    iput-object v0, p0, Lajr;->mImageUrl:Ljava/lang/String;

    .line 50
    iget-boolean v0, p1, Lcom/snapchat/android/model/server/GeofilterResponse;->mIsSponsored:Z

    iput-boolean v0, p0, Lajr;->mIsSponsored:Z
    ...
    iput-object v0, p0, Lajr;->mSponsoredSlugPosition:Lcom/snapchat/android/model/server/GeofilterResponse$SponsoredSlugPosition;

    .line 52
    iget-object v0, p1, Lcom/snapchat/android/model/server/GeofilterResponse;->mSponsoredSlugImageUrl:Ljava/lang/String;

    iput-object v0, p0, Lajr;->mSponsoredSlugImageUrl:Ljava/lang/String;
    ...
    :goto_0
    iput-wide v0, p0, Lajr;->mExpirationTime:J

    .line 54
    iget-object v0, p1, Lcom/snapchat/android/model/server/GeofilterResponse;->mGeofence:Lbiz;
    ...
    iput-object v0, p0, Lajr;->mGeofence:Lajq;
    ...
    iput-object v0, p0, Lajr;->mLayoutScaleType:Landroid/widget/ImageView$ScaleType;
    ...
    iput v0, p0, Lajr;->mLayoutGravity:I

    .line 62
    iget-object v0, p1, Lcom/snapchat/android/model/server/GeofilterResponse;->mDynamicContent:Ljava/util/List;

    iput-object v0, p0, Lajr;->mDynamicContent:Ljava/util/List;

    .line 63
    iget-boolean v0, p1, Lcom/snapchat/android/model/server/GeofilterResponse;->mIsDynamic:Z

    iput-boolean v0, p0, Lajr;->mIsDynamic:Z

    .line 64
    iget-object v0, p1, Lcom/snapchat/android/model/server/GeofilterResponse;->mClientCacheTtlMinutes:Ljava/lang/Long;

    iput-object v0, p0, Lajr;->mClientCacheTtlMinutes:Ljava/lang/Long;

    .line 65
    iget-object v0, p1, Lcom/snapchat/android/model/server/GeofilterResponse;->mClientCacheExpiration:Lcht;

    .line 66
    if-nez v0, :cond_4

    .line 67
    iget-object v1, p0, Lajr;->mClientCacheTtlMinutes:Ljava/lang/Long;
    ...
    invoke-virtual {v1, v0}, Lcht;->b(I)Lcht;

    move-result-object v0

    iput-object v0, p0, Lajr;->mClientCacheExpiration:Lcht;
    ...
    iput v0, p0, Lajr;->mPriority:I

    .line 76
    invoke-direct {p0}, Lajr;->d()V
    ...
    invoke-direct {v1, v0}, Lajq;-><init>(Lbiz;)V

    iput-object v1, p0, Lajr;->mGeofence:Lajq;
...
.method private d()V
    ...
    .prologue
    .line 122
    iget-boolean v0, p0, Lajr;->mIsDynamic:Z

    if-eqz v0, :cond_3

    .line 123
    invoke-virtual {p0}, Lajr;->c()Ljava/util/List;
    ...
    .line 129
    iget-object v2, v0, Lcom/snapchat/android/model/GeofilterMarkup;->displayParameters:Lajs;

    iget-object v2, v2, Lajs;->font:Ljava/lang/String;
    ...
    .line 134
    iget-object v0, v0, Lcom/snapchat/android/model/GeofilterMarkup;->layoutParameters:Lajt;
...
.method public final a()Landroid/graphics/Bitmap;
    ...
    .prologue
    .line 197
    iget-object v1, p0, Lajr;->mCompositeLock:Ljava/lang/Object;

    monitor-enter v1

    .line 198
    :try_start_0
    iget-object v0, p0, Lajr;->mCompositeBitmap:Landroid/graphics/Bitmap;
...
.method public final b()Lcht;
    ...
    .line 210
    :try_start_0
    iget-object v0, p0, Lajr;->mCompositeBitmapExpiryTime:Lcht;
...
.method public final c()Ljava/util/List;
    ...
    .prologue
    .line 235
    iget-object v0, p0, Lajr;->mDynamicContent:Ljava/util/List;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 266
    iget-object v0, p0, Lajr;->mFilterId:Ljava/lang/String;
