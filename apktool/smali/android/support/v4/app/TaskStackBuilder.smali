...
.method private addNextIntent(Landroid/content/Intent;)Landroid/support/v4/app/TaskStackBuilder;
    .locals 1
...
.method private addNextIntentWithParentStack(Landroid/content/Intent;)Landroid/support/v4/app/TaskStackBuilder;
    .locals 1
    ...
    .line 183
    invoke-direct {p0, v0}, Landroid/support/v4/app/TaskStackBuilder;->addParentStack(Landroid/content/ComponentName;)Landroid/support/v4/app/TaskStackBuilder;

    .line 185
    :cond_1
    invoke-direct {p0, p1}, Landroid/support/v4/app/TaskStackBuilder;->addNextIntent(Landroid/content/Intent;)Landroid/support/v4/app/TaskStackBuilder;

    .line 186
    return-object p0
.end method

.method private addParentStack(Landroid/app/Activity;)Landroid/support/v4/app/TaskStackBuilder;
    .locals 2
    ...
    .line 213
    invoke-direct {p0, v1}, Landroid/support/v4/app/TaskStackBuilder;->addNextIntent(Landroid/content/Intent;)Landroid/support/v4/app/TaskStackBuilder;
...
.method private addParentStack(Landroid/content/ComponentName;)Landroid/support/v4/app/TaskStackBuilder;
    .locals 3
...
.method private addParentStack(Ljava/lang/Class;)Landroid/support/v4/app/TaskStackBuilder;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static create(Landroid/content/Context;)Landroid/support/v4/app/TaskStackBuilder;
    .locals 1
...
.method private editIntentAt(I)Landroid/content/Intent;
    .locals 1
...
.method private static from(Landroid/content/Context;)Landroid/support/v4/app/TaskStackBuilder;
    .locals 1
...
.method private getIntentCount()I
    .locals 1
...
.method private getIntents()[Landroid/content/Intent;
    .locals 4
...
.method private getPendingIntent(II)Landroid/app/PendingIntent;
    .locals 4
    ...
    invoke-interface {v1, v2, v0, p1, p2}, Landroid/support/v4/app/TaskStackBuilder$TaskStackBuilderImpl;->getPendingIntent$3140f641(Landroid/content/Context;[Landroid/content/Intent;II)Landroid/app/PendingIntent;
...
.method private getPendingIntent$669578cb(II)Landroid/app/PendingIntent;
    .locals 4
...
.method private startActivities()V
    .locals 4
    ...
    invoke-static {v1, v0}, Landroid/support/v4/content/ContextCompat;->startActivities$5b3ef247(Landroid/content/Context;[Landroid/content/Intent;)Z
...
.method private startActivities$79e5e33f()V
    .locals 4
