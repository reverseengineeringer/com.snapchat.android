...
# direct methods
.method public constructor <init>(Landroid/support/v4/app/LoaderManagerImpl;ILandroid/support/v4/app/LoaderManager$LoaderCallbacks;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
    ...
    .line 231
    iput-object p3, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mCallbacks:Landroid/support/v4/app/LoaderManager$LoaderCallbacks;
...
.method public final onLoadComplete(Landroid/support/v4/content/Loader;Ljava/lang/Object;)V
    ...
    iget-object v2, v0, Landroid/support/v4/util/SparseArrayCompat;->mKeys:[I

    iget v3, v0, Landroid/support/v4/util/SparseArrayCompat;->mSize:I

    invoke-static {v2, v3, v1}, Landroid/support/v4/util/ContainerHelpers;->binarySearch([III)I

    move-result v1

    if-ltz v1, :cond_7

    iget-object v2, v0, Landroid/support/v4/util/SparseArrayCompat;->mValues:[Ljava/lang/Object;
    ...
    iput-boolean v4, v0, Landroid/support/v4/util/SparseArrayCompat;->mGarbage:Z
