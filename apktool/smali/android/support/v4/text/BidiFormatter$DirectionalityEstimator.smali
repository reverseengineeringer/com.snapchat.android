...
.method private dirTypeForward()B
    .locals 7
    ...
    invoke-static {v1}, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->getCachedDirectionality(C)B
...
.method static getCachedDirectionality(C)B
    .locals 1
...
.method private getEntryDir()I
    ...
    iget v8, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->length:I
    ...
    .line 572
    iget-object v6, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->text:Ljava/lang/String;

    iget v8, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->charIndex:I
    ...
    iput v8, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->charIndex:I
    ...
    iget-boolean v8, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->isHtml:Z

    if-eqz v8, :cond_0

    iget-char v8, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->lastChar:C
    ...
    iget v9, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->length:I

    if-ge v8, v9, :cond_6

    iget-object v8, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->text:Ljava/lang/String;

    iget v9, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->charIndex:I

    add-int/lit8 v10, v9, 0x1

    iput v10, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->charIndex:I

    invoke-virtual {v8, v9}, Ljava/lang/String;->charAt(I)C

    move-result v8

    iput-char v8, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->lastChar:C
    ...
    iget v10, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->length:I

    if-ge v9, v10, :cond_2

    iget-object v9, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->text:Ljava/lang/String;

    iget v10, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->charIndex:I

    add-int/lit8 v11, v10, 0x1

    iput v11, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->charIndex:I

    invoke-virtual {v9, v10}, Ljava/lang/String;->charAt(I)C

    move-result v9

    iput-char v9, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->lastChar:C
    ...
    iput-char v12, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->lastChar:C
    ...
    iput v9, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->charIndex:I
...
# virtual methods
.method final dirTypeBackward()B
    .locals 7
    ...
    iget-object v4, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->text:Ljava/lang/String;
