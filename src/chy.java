...
final class chy
{
  private static final chy[] n = new chy[64];
  private static WeakHashMap<Locale, chy> o = new WeakHashMap();
  final String[] a;
  final String[] b;
  final String[] c;
  final String[] d;
  ...
  private chy(Locale paramLocale)
  {
    p = new WeakReference(paramLocale);
    Object localObject = cgj.a(paramLocale);
  ...
  public static chy a(Locale paramLocale)
  {
    ...
    synchronized (o)
    {
      chy localchy = (chy)o.get(localLocale);
      paramLocale = localchy;
      if (localchy == null)
      {
        paramLocale = new chy(localLocale);
