...
{
  public static Intent a(Context paramContext, AndroidNotificationManager.Type paramType, @cgc AndroidNotificationManager.a parama, @cgc AndroidNotificationManager.b paramb, boolean paramBoolean)
  {
    paramContext = new Intent(paramContext, LandingPageActivity.class);
    paramContext.putExtra("fromNotification", true);
    switch (aly.1.a[paramType.ordinal()])
    {
    default: 
      if (parama != null)
      {
