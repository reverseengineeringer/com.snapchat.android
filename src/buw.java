  ...
  implements Animatable
{
  ...
  private static final Interpolator d = new buw.a((byte)0);
  private static final Interpolator e = new buw.d((byte)0);
  private static final Interpolator f = new AccelerateDecelerateInterpolator();
  public final buw.c a;
  public int b;
  ...
  public buw(final Context paramContext, View paramView)
  {
    l = paramView;
    ...
    for (f1 = (float)Math.ceil(h / 2.0F);; f1 = (float)(f1 / 2.0F - r))
    {
      ...
      int i2 = buy.a(0.0F);
      int i3 = buy.a(3.5F);
      r = new ShapeDrawable(new buw.b(i3, (int)d1));
      ...
      paramView.setAnimationListener(new Animation.AnimationListener()
      {
        public final void onAnimationEnd(Animation paramAnonymousAnimation)
        {
          ...
          buw.b(buw.this).startAnimation(buw.a(buw.this));
        }
      ...
      Animation local4 = new Animation()
      {
        public final void applyTransformation(float paramAnonymousFloat, Transformation paramAnonymousTransformation)
        {
          ...
          float f5 = buw.a().getInterpolation(paramAnonymousFloat);
          paramContext.b((0.8F - f3) * f5 + f4);
          f3 = buw.b().getInterpolation(paramAnonymousFloat);
          paramContext.a(f3 * 0.8F + f1);
          paramContext.c(0.25F * paramAnonymousFloat + f2);
          f1 = buw.c(buw.this) / 5.0F;
      ...
      local4.setAnimationListener(new Animation.AnimationListener()
      {
        ...
        public final void onAnimationRepeat(Animation paramAnonymousAnimation)
        {
          ...
          buw.a(buw.this, (buw.c(buw.this) + 1.0F) % 5.0F);
        }
    ...
    extends OvalShape
  {
    ...
    public b(int paramInt1, int paramInt2)
    {
      ...
      b = new RadialGradient(f1, f2, f3, new int[] { 1023410176, 0 }, null, buw.this);
      d.setShader(b);
    }
