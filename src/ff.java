...
{
  private static final as EOF = new fc("eof ")
  {
  ...
  public ByteBuffer getByteBuffer(long paramLong1, long paramLong2)
  {
    ...
    ??? = ByteBuffer.allocate(fn.a(paramLong2));
    ...
    for (;;)
    {
      ...
      if ((l1 > paramLong1) && (paramLong2 < l2))
      {
        ...
        if ((paramLong2 < paramLong1) && (l1 > l2))
        {
          i = fn.a(localas.getSize() - (paramLong1 - paramLong2) - (l1 - l2));
          ((ByteBuffer)???).put(localByteArrayOutputStream.toByteArray(), fn.a(paramLong1 - paramLong2), i);
          paramLong2 = l1;
          continue;
        }
        if ((paramLong2 < paramLong1) && (l1 <= l2))
        {
          i = fn.a(localas.getSize() - (paramLong1 - paramLong2));
          ((ByteBuffer)???).put(localByteArrayOutputStream.toByteArray(), fn.a(paramLong1 - paramLong2), i);
          paramLong2 = l1;
          continue;
        }
  ...
  public as next()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 52	ff:lookahead	Las;
    //   4: ifnull +25 -> 29
    //   7: aload_0
    //   8: getfield 52	ff:lookahead	Las;
    //   11: getstatic 39	ff:EOF	Las;
    //   14: if_acmpeq +15 -> 29
    //   17: aload_0
    //   18: getfield 52	ff:lookahead	Las;
    //   21: astore_1
    //   22: aload_0
    //   23: aconst_null
    //   24: putfield 52	ff:lookahead	Las;
    //   27: aload_1
    //   28: areturn
    //   29: aload_0
    //   30: getfield 87	ff:dataSource	Lfg;
    //   33: ifnull +15 -> 48
    //   36: aload_0
    //   37: getfield 54	ff:parsePosition	J
    //   40: aload_0
    //   41: getfield 58	ff:endPosition	J
    //   44: lcmp
    //   45: iflt +18 -> 63
    //   48: aload_0
    //   49: getstatic 39	ff:EOF	Las;
    //   52: putfield 52	ff:lookahead	Las;
    //   55: new 198	java/util/NoSuchElementException
    //   58: dup
    //   59: invokespecial 216	java/util/NoSuchElementException:<init>	()V
    //   62: athrow
    //   63: aload_0
    //   64: getfield 87	ff:dataSource	Lfg;
    //   67: astore_1
    //   68: aload_1
    //   69: monitorenter
    //   70: aload_0
    //   71: getfield 87	ff:dataSource	Lfg;
    //   74: aload_0
    //   75: getfield 54	ff:parsePosition	J
    //   78: invokeinterface 209 3 0
    //   83: aload_0
    //   84: getfield 211	ff:boxParser	Lal;
    //   87: aload_0
    //   88: getfield 87	ff:dataSource	Lfg;
    //   91: aload_0
    //   92: invokeinterface 221 3 0
    //   97: astore_2
    //   98: aload_0
    //   99: aload_0
    //   100: getfield 87	ff:dataSource	Lfg;
    //   103: invokeinterface 206 1 0
    //   108: putfield 54	ff:parsePosition	J
    //   111: aload_1
    //   112: monitorexit
    //   113: aload_2
    //   114: areturn
