  ...
  implements caj
{
  ...
  private void a(bzu parambzu, long paramLong1, long paramLong2)
  {
    Object localObject;
    long l1;
    long l2;
    for (parambzu = a;; parambzu = f)
    {
      localObject = parambzu;
      l1 = paramLong1;
      l2 = paramLong2;
      if (paramLong1 < c - b) {
        break;
  ...
  public final long a(bzu parambzu, long paramLong)
  {
    ...
    {
      l = b;
      paramLong = d.a(parambzu, paramLong);
      if (paramLong != -1L)
      {
        a(parambzu, l, paramLong);
        return paramLong;
      }
      a = 2;
    }
