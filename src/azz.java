...
public final class azz
{
  ...
  private static bgk mClock = null;
  ...
  private static long a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    if (sAppStartTime == null)
    {
      ...
      l1 = 0L;
      switch (azz.1.$SwitchMap$com$snapchat$android$util$debug$TimeLogger$Type[(paramInt - 1)])
      {
      }
    }
    for (;;)
    {
      ...
      do
      {
        ...
        break label72;
        l3 = l2 - aud.a((Long)sEventStartTimeMap.get(paramString));
        l2 = l3;
      } while (!paramBoolean);
  ...
  {
    a(paramString, azz.a.BEGIN$1a20a190, false);
  }
  
  public static long b(String paramString)
  {
    return a(paramString, azz.a.END$1a20a190, false);
  }
  ...
  {
    if (ReleaseManager.f()) {
      a(paramString, azz.a.ONE_TIME_EVENT$1a20a190, true);
    }
  }
