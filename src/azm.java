...
public final class azm
{
  ...
  private static final azm sInstance = new azm();
  ...
  {
    SharedPreferences.Editor localEditor = PreferenceManager.getDefaultSharedPreferences(SnapchatApplication.b()).edit();
    localEditor.putBoolean(SharedPreferenceKey.DEVELOPER_OPTIONS_NEW_FEED.getKey(), paramBoolean);
    localEditor.apply();
  }
  ...
  {
    return PreferenceManager.getDefaultSharedPreferences(SnapchatApplication.b()).getBoolean(SharedPreferenceKey.DEVELOPER_OPTIONS_HORIZONTAL_SCROLL.getKey(), false);
  }
  
  public static boolean e()
  {
    return PreferenceManager.getDefaultSharedPreferences(SnapchatApplication.b()).getBoolean(SharedPreferenceKey.DEVELOPER_OPTIONS_NEW_FEED.getKey(), false);
  }
}
