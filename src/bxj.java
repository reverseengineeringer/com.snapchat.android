...
public final class bxj
{
  public static String a(String paramString, char paramChar)
  {
    ...
    {
      throw new bxh("Value does not start with a quote.");
    }
    throw new bxh("Value does not end with a quote.");
  }
  ...
  public static ArrayList a(String paramString)
  {
    ...
    {
      throw new bxh("Invalid values in string.", paramString);
    }
  }
  ...
  public static ArrayList c(String paramString)
  {
    ...
    for (;;)
    {
      ...
      throw new bxh("Invalid values in string.");
      label101:
      return localArrayList;
      i += 1;
    }
