...
{
  private static ViewPager.SavedState createFromParcel(Parcel paramParcel, ClassLoader paramClassLoader)
  {
    return new ViewPager.SavedState(paramParcel, paramClassLoader);
  }
  
  private static ViewPager.SavedState[] newArray(int paramInt)
  {
