...
{
  private static String[] appendSelectionArgs(String[] paramArrayOfString1, String[] paramArrayOfString2)
  {
  ...
  private static String concatenateWhere(String paramString1, String paramString2)
  {
