...
final class INotificationSideChannel$Stub$Proxy
  implements INotificationSideChannel
{
  ...
  /* Error */
  public final void notify(String paramString1, int paramInt, String paramString2, android.app.Notification paramNotification)
  {
    // Byte code:
