  ...
  extends Fragment
{
  ...
  private void ensureList()
  {
    ...
    if ((localObject instanceof ListView))
    {
      ...
      if (mList != null)
      {
        mList.setAdapter((ListAdapter)localObject);
        if ((!mListShown) && (i == 0))
        {
  ...
  private void setEmptyText(CharSequence paramCharSequence)
  {
    ensureList();
    if (mStandardEmptyView == null) {
  ...
  private void setListShownNoAnimation(boolean paramBoolean)
  {
