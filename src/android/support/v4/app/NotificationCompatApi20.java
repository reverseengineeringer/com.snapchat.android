  ...
  private static NotificationCompatBase.Action getActionCompatFromAction(Notification.Action paramAction, NotificationCompatBase.Action.Factory paramFactory, RemoteInputCompatBase.RemoteInput.Factory paramFactory1)
  {
    ...
    for (paramFactory1 = null;; paramFactory1 = arrayOfRemoteInput)
    {
      ...
      while (i < arrayOfRemoteInput1.length)
      {
        ...
        arrayOfRemoteInput[i] = paramFactory1.build(localRemoteInput.getResultKey(), localRemoteInput.getLabel(), localRemoteInput.getChoices(), localRemoteInput.getAllowFreeFormInput(), localRemoteInput.getExtras());
        i += 1;
      }
    }
  }
