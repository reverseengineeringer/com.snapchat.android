...
final class NotificationCompatJellybean
{
  ...
  public static NotificationCompatBase.Action[] getActionsFromParcelableArrayList(ArrayList<Parcelable> paramArrayList, NotificationCompatBase.Action.Factory paramFactory, RemoteInputCompatBase.RemoteInput.Factory paramFactory1)
  {
    ...
    while (i < arrayOfAction.length)
    {
      ...
      arrayOfAction[i] = paramFactory.build(localBundle.getInt("icon"), localBundle.getCharSequence("title"), (PendingIntent)localBundle.getParcelable("actionIntent"), localBundle.getBundle("extras"), RemoteInputCompatJellybean.fromBundleArray(BundleUtil.getBundleArrayFromBundle(localBundle, "remoteInputs"), paramFactory1));
      i += 1;
    }
  ...
  public static ArrayList<Parcelable> getParcelableArrayListForActions(NotificationCompatBase.Action[] paramArrayOfAction)
  {
    ...
    for (;;)
    {
      ...
      localObject = paramArrayOfAction[i];
      Bundle localBundle = new Bundle();
      ...
      localBundle.putParcelableArray("remoteInputs", RemoteInputCompatJellybean.toBundleArray(((NotificationCompatBase.Action)localObject).getRemoteInputs()));
