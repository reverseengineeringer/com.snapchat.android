  ...
  implements Parcelable
{
  ...
  {
    private static FragmentState createFromParcel(Parcel paramAnonymousParcel)
    {
      return new FragmentState(paramAnonymousParcel);
    }
    
    private static FragmentState[] newArray(int paramAnonymousInt)
    {
  ...
  private Fragment instantiate(FragmentActivity paramFragmentActivity, Fragment paramFragment)
  {
    if (mInstance != null) {
      return mInstance;
    }
