  ...
  implements ComponentCallbacks, View.OnCreateContextMenuListener
{
  ...
  public void onActivityCreated(@r Bundle paramBundle)
  {
    mCalled = true;
  }
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, @r ViewGroup paramViewGroup, @r Bundle paramBundle)
  {
    return null;
  }
  ...
  public void onViewCreated(View paramView, @r Bundle paramBundle) {}
  
  public void onViewStateRestored(@r Bundle paramBundle)
  {
    mCalled = true;
  }
  ...
  {
    if (mChildFragmentManager != null) {
      mChildFragmentManager.moveToState$2563266(1);
    }
    mCalled = false;
    onDestroyView();
    if (!mCalled) {
  ...
  {
    if (mChildFragmentManager != null) {
      mChildFragmentManager.moveToState$2563266(4);
    }
    mCalled = false;
    onPause();
    if (!mCalled) {
  ...
  {
    if (mChildFragmentManager != null) {
      mChildFragmentManager.moveToState$2563266(2);
    }
    if (mLoadersStarted)
    {
      mLoadersStarted = false;
    ...
    implements Parcelable
  {
    ...
    {
      private static Fragment.SavedState createFromParcel(Parcel paramAnonymousParcel)
      {
        return new Fragment.SavedState(paramAnonymousParcel);
      }
      
      private static Fragment.SavedState[] newArray(int paramAnonymousInt)
      {
