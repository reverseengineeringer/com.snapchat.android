  ...
  implements TabHost.OnTabChangeListener
{
  ...
  private void addTab(TabHost.TabSpec paramTabSpec, Class<?> paramClass, Bundle paramBundle)
  {
  ...
  static final class DummyTabFactory
    ...
    extends View.BaseSavedState
  {
    ...
    {
      private static FragmentTabHost.SavedState createFromParcel(Parcel paramAnonymousParcel)
      {
        return new FragmentTabHost.SavedState(paramAnonymousParcel, (byte)0);
      }
      
      private static FragmentTabHost.SavedState[] newArray(int paramAnonymousInt)
      {
