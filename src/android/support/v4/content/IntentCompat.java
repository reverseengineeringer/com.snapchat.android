...
public final class IntentCompat
{
  ...
  private static Intent makeMainSelectorActivity(String paramString1, String paramString2)
  {
    return IMPL.makeMainSelectorActivity(paramString1, paramString2);
  }
  
  private static Intent makeRestartActivityTask(ComponentName paramComponentName)
  {
  ...
  {
    public final Intent makeMainSelectorActivity(String paramString1, String paramString2)
    {
