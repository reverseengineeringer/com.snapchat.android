  ...
  extends Drawable
{
  ...
  private void setAntiAlias(boolean paramBoolean)
  {
    mPaint.setAntiAlias(paramBoolean);
    invalidateSelf();
  }
  
  private void setCornerRadius(float paramFloat)
  {
  ...
  private void setTargetDensity(int paramInt)
  {
  ...
  private void setTargetDensity(Canvas paramCanvas)
  {
    setTargetDensity(paramCanvas.getDensity());
  }
  
  private void setTargetDensity(DisplayMetrics paramDisplayMetrics)
  {
