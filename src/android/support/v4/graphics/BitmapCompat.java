...
public final class BitmapCompat
{
  ...
  private static int getAllocationByteCount(Bitmap paramBitmap)
  {
  ...
  {
    public final boolean hasMipMap(Bitmap paramBitmap)
    {
      return BitmapCompatJellybeanMR2.hasMipMap(paramBitmap);
    }
    
    public final void setHasMipMap(Bitmap paramBitmap, boolean paramBoolean)
    {
      BitmapCompatJellybeanMR2.setHasMipMap(paramBitmap, paramBoolean);
    }
  }
  
  static final class KitKatBitmapCompatImpl
    extends BitmapCompat.JbMr2BitmapCompatImpl
  {
    public final int getAllocationByteCount(Bitmap paramBitmap)
    {
