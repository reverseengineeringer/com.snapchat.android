...
final class SwipeProgressBar
{
  ...
  private SwipeProgressBar(View paramView)
  {
    mParent = paramView;
    mColor1 = -1291845632;
  ...
  private void draw(Canvas paramCanvas)
  {
    ...
    if ((mRunning) || (mFinishTime > 0L))
    {
      ...
      mClipRect.set(k - f2, 0.0F, f2 + k, j);
  ...
  private void setColorScheme(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    mColor1 = paramInt1;
    mColor2 = paramInt2;
    mColor3 = paramInt3;
