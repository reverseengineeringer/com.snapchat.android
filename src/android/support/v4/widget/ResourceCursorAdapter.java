  ...
  extends CursorAdapter
{
  ...
  private ResourceCursorAdapter(Context paramContext, int paramInt, Cursor paramCursor, boolean paramBoolean)
  {
  ...
  private void setDropDownViewResource(int paramInt)
  {
    mDropDownLayout = paramInt;
  }
  
  private void setViewResource(int paramInt)
  {
    mLayout = paramInt;
  }
  
  public final View newDropDownView$4b8874c5(ViewGroup paramViewGroup)
  {
