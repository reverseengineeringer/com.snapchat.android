...
public final class AccessibilityServiceInfoCompat
{
  ...
  private static String capabilityToString(int paramInt)
  {
    switch (paramInt)
    {
    case 3: 
  ...
  private static String feedbackTypeToString(int paramInt)
  {
  ...
  private static String flagToString(int paramInt)
  {
    switch (paramInt)
    {
    default: 
  ...
  private static boolean getCanRetrieveWindowContent(AccessibilityServiceInfo paramAccessibilityServiceInfo)
  {
    return IMPL.getCanRetrieveWindowContent(paramAccessibilityServiceInfo);
  }
  
  private static int getCapabilities(AccessibilityServiceInfo paramAccessibilityServiceInfo)
  {
    return IMPL.getCapabilities(paramAccessibilityServiceInfo);
  }
  
  private static String getDescription(AccessibilityServiceInfo paramAccessibilityServiceInfo)
  {
    return IMPL.getDescription(paramAccessibilityServiceInfo);
  }
  
  private static String getId(AccessibilityServiceInfo paramAccessibilityServiceInfo)
  {
    return IMPL.getId(paramAccessibilityServiceInfo);
  }
  
  private static ResolveInfo getResolveInfo(AccessibilityServiceInfo paramAccessibilityServiceInfo)
  {
    return IMPL.getResolveInfo(paramAccessibilityServiceInfo);
  }
  
  private static String getSettingsActivityName(AccessibilityServiceInfo paramAccessibilityServiceInfo)
  {
  ...
  static final class AccessibilityServiceInfoJellyBeanMr2
    extends AccessibilityServiceInfoCompat.AccessibilityServiceInfoIcsImpl
  {
    public final int getCapabilities(AccessibilityServiceInfo paramAccessibilityServiceInfo)
    {
