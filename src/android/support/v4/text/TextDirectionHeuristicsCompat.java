...
public final class TextDirectionHeuristicsCompat
{
    ...
    implements TextDirectionHeuristicsCompat.TextDirectionAlgorithm
  {
    ...
    public final int checkRtl(CharSequence paramCharSequence, int paramInt1, int paramInt2)
    {
      int k = 1;
      int j = 0;
      int m;
  ...
  static final class FirstStrong
    implements TextDirectionHeuristicsCompat.TextDirectionAlgorithm
  {
    ...
    implements TextDirectionHeuristicCompat
  {
    ...
    public final boolean isRtl(CharSequence paramCharSequence, int paramInt1, int paramInt2)
    {
    ...
    public final boolean isRtl(char[] paramArrayOfChar, int paramInt1, int paramInt2)
    {
      return isRtl(CharBuffer.wrap(paramArrayOfChar), paramInt1, paramInt2);
    }
  }
  
  static final class TextDirectionHeuristicInternal
  ...
  static final class TextDirectionHeuristicLocale
    extends TextDirectionHeuristicsCompat.TextDirectionHeuristicImpl
  {
