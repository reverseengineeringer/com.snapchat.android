...
public final class bpg
{
  ...
  private bpg(Uri paramUri, int paramInt1, String paramString, List<bpm> paramList, int paramInt2, int paramInt3, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, float paramFloat1, float paramFloat2, float paramFloat3, boolean paramBoolean4, Bitmap.Config paramConfig, int paramInt4)
  {
    d = paramUri;
    e = paramInt1;
    f = paramString;
  ...
  public final String toString()
  {
    ...
    while ((g != null) && (!g.isEmpty()))
    {
      ...
      {
        bpm localbpm = (bpm)localIterator.next();
        localStringBuilder.append(' ').append(localbpm.b());
      }
