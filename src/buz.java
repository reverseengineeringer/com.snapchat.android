  ...
  extends HttpURLConnection
{
  ...
  public buz(HttpURLConnection paramHttpURLConnection, bum parambum, btx parambtx)
  {
    super(paramHttpURLConnection.getURL());
    b = paramHttpURLConnection;
    a = parambum;
    d = parambtx;
    c = new btc(paramHttpURLConnection.getURL());
  }
  ...
  private void b()
  {
    ...
    //   3: istore_1
    //   4: aload_0
    //   5: getfield 26	buz:e	Z
    //   8: ifne +151 -> 159
    //   11: aload_0
    //   12: iconst_1
    //   13: putfield 26	buz:e	Z
    //   16: aload_0
    //   17: getfield 39	buz:c	Lbtc;
    //   20: invokevirtual 81	btc:d	()V
    //   23: aload_0
    //   24: getfield 30	buz:b	Ljava/net/HttpURLConnection;
    //   27: invokevirtual 101	java/net/HttpURLConnection:getHeaderFields	()Ljava/util/Map;
    //   30: ifnull +100 -> 130
    //   33: new 103	bux
    //   36: dup
    //   37: aload_0
    //   38: getfield 30	buz:b	Ljava/net/HttpURLConnection;
    //   41: invokevirtual 101	java/net/HttpURLConnection:getHeaderFields	()Ljava/util/Map;
    //   44: invokespecial 106	bux:<init>	(Ljava/util/Map;)V
    //   47: astore 7
    //   49: aload 7
    //   51: ldc 108
    //   53: invokevirtual 111	bux:b	(Ljava/lang/String;)I
    //   56: istore_2
    //   57: iload_2
    //   58: iconst_m1
    //   59: if_icmpeq +14 -> 73
    //   62: aload_0
    //   63: getfield 39	buz:c	Lbtc;
    //   66: iload_2
    //   67: i2l
    //   68: invokevirtual 114	btc:b	(J)V
    //   71: iconst_1
    //   72: istore_1
    //   73: aload 7
    //   75: ldc 116
    //   77: invokevirtual 119	bux:a	(Ljava/lang/String;)J
    //   80: lstore_3
    //   81: aload 7
    //   83: ldc 121
    //   85: invokevirtual 119	bux:a	(Ljava/lang/String;)J
    //   88: lstore 5
    //   90: iload_1
    //   91: istore_2
    //   92: lload_3
    ...
    //   108: ifeq +22 -> 130
    //   111: aload_0
    //   112: getfield 39	buz:c	Lbtc;
    //   115: lload_3
    //   116: invokevirtual 125	btc:e	(J)V
    //   119: aload_0
    //   120: getfield 39	buz:c	Lbtc;
    //   123: lload 5
    //   125: invokevirtual 127	btc:f	(J)V
    //   128: iload_1
    //   129: istore_2
    //   130: aload_0
    //   131: getfield 39	buz:c	Lbtc;
    //   134: aload_0
    //   135: getfield 30	buz:b	Ljava/net/HttpURLConnection;
    //   138: invokevirtual 131	java/net/HttpURLConnection:getResponseCode	()I
    //   141: putfield 134	btc:e	I
    //   144: iload_2
    //   145: ifeq +14 -> 159
    //   148: aload_0
    //   149: getfield 32	buz:a	Lbum;
    //   152: aload_0
    //   153: getfield 39	buz:c	Lbtc;
    //   156: invokevirtual 95	bum:a	(Lbtc;)V
    //   159: return
    //   160: astore 7
    //   162: aload 7
    //   164: athrow
    //   165: astore 7
    //   167: aload 7
    //   169: invokestatic 79	bue:a	(Ljava/lang/Throwable;)V
    //   172: return
    //   173: astore 7
    //   175: goto -31 -> 144
  ...
  public final InputStream getInputStream()
  {
    // Byte code:
    //   0: aload_0
    //   1: invokespecial 162	buz:a	()V
    //   4: aload_0
    //   5: getfield 30	buz:b	Ljava/net/HttpURLConnection;
    //   8: invokevirtual 228	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   11: astore_1
    //   12: aload_0
    //   13: invokespecial 166	buz:b	()V
    //   16: aload_1
    //   17: ifnull +38 -> 55
    //   20: new 198	bvb
    //   23: dup
    //   24: aload_1
    //   25: aload_0
    //   26: getfield 32	buz:a	Lbum;
    //   29: aload_0
    //   30: getfield 39	buz:c	Lbtc;
    //   33: invokespecial 201	bvb:<init>	(Ljava/io/InputStream;Lbum;Lbtc;)V
    //   36: astore_2
    //   37: aload_2
    //   38: areturn
    //   39: astore_1
    //   40: aload_0
    //   41: aload_1
    //   42: invokespecial 167	buz:a	(Ljava/lang/Throwable;)V
    //   45: aload_1
    //   46: athrow
    //   47: astore_1
    //   48: aload_1
    ...
    //   50: astore_2
    //   51: aload_2
    //   52: invokestatic 79	bue:a	(Ljava/lang/Throwable;)V
    //   55: aload_1
    //   56: areturn
    // Local variable table:
    //   start	length	slot	name	signature
