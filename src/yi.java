...
public final class yi
{
  ...
  public yi(@cgb ListView paramListView)
  {
    a = paramListView;
  }
  
  public static boolean a(@cgc ChatFeedItem paramChatFeedItem1, @cgc ChatFeedItem paramChatFeedItem2)
  {
    return ((paramChatFeedItem1 != null) && (paramChatFeedItem1.am())) || ((paramChatFeedItem2 != null) && (paramChatFeedItem2.am()));
  }
  ...
  public final void a()
  {
    ...
    while (i <= k)
    {
      afr.c localc = (afr.c)a.getChildAt(i - j).getTag();
      if (localc != null)
      {
        localc.a();
        if (L != null) {
  ...
  public final void a(@cgb afr.c paramc, float paramFloat)
  {
