  ...
  implements ckn
{
  ...
  public ckp(String paramString)
  {
    this(paramString, (byte)0);
  }
  
  private ckp(String paramString, byte paramByte)
  {
    if (paramString == null) {
  ...
  private static Map<String, Object> a(InputStream paramInputStream)
  {
    ...
    //   17: aload_0
    //   18: aload_1
    //   19: invokestatic 91	ckp:a	(Ljava/io/DataInputStream;Ljava/util/Map;)V
    //   22: aload_0
  ...
  /* Error */
  private cgk c(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: aload_1
    //   2: invokespecial 73	ckp:b	(Ljava/lang/String;)Ljava/io/InputStream;
    //   5: astore_3
    //   6: aload_3
    //   7: astore_2
    //   8: aload_3
    ...
    //   21: aload_1
    //   22: invokestatic 170	ckj:a	(Ljava/io/DataInput;Ljava/lang/String;)Lcgk;
    //   25: astore 4
    //   27: aload_3
    //   28: astore_2
    //   29: aload_0
    //   30: getfield 78	ckp:d	Ljava/util/Map;
    //   33: aload_1
    ...
    //   70: aload_1
    //   71: invokestatic 170	ckj:a	(Ljava/io/DataInput;Ljava/lang/String;)Lcgk;
    //   74: astore 4
    //   76: goto -49 -> 27
    //   79: astore 4
    //   81: aconst_null
    ...
    //   105: astore_2
    //   106: aload_0
    //   107: getfield 78	ckp:d	Ljava/util/Map;
    //   110: aload_1
  ...
  public final cgk a(String paramString)
  {
    for (;;)
    {
      ...
      do
      {
        ...
        localcgk = (cgk)((SoftReference)localObject).get();
