...
public class bsl
{
  private static final String c = bsl.class.getName();
  String a;
  String b;
  ...
  public bsl(Context paramContext, bsk parambsk)
  {
    this(new File(paramContext.getFilesDir().getAbsolutePath() + "//com.crittercism//" + str), l, m, k, j, o, n);
  }
  
  private bsl(File paramFile, bsl.a parama, bsy parambsy, int paramInt1, int paramInt2, String paramString1, String paramString2)
  {
    i = parama;
    e = parambsy;
    h = paramInt1;
  ...
  public final bsl a(Context paramContext)
  {
    String str = d.getName();
    str = str + "_" + UUID.randomUUID().toString();
    return new bsl(new File(paramContext.getFilesDir().getAbsolutePath() + "//com.crittercism/pending/" + str), i, e, h, g, a, b);
  }
  ...
  public final void a()
  {
    ...
    //   13: return
    //   14: aload_0
    //   15: invokespecial 112	bsl:h	()[Ljava/io/File;
    //   18: astore_3
    //   19: iconst_0
    //   20: istore_1
    //   21: iload_1
  ...
  /* Error */
  public final boolean a(bsx parambsx)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore 4
    ...
    //   20: ireturn
    //   21: aload_0
    //   22: getfield 114	bsl:f	I
    //   25: aload_0
    //   26: getfield 95	bsl:h	I
    //   29: if_icmplt +17 -> 46
    //   32: invokestatic 187	bue:b	()V
    //   35: iload 4
    //   37: istore_3
    //   38: goto -21 -> 17
    //   41: astore_1
    ...
    //   49: dup
    //   50: aload_0
    //   51: getfield 103	bsl:d	Ljava/io/File;
    //   54: aload_1
    //   55: invokeinterface 191 1 0
    //   60: invokespecial 176	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   63: astore 5
    //   65: aload_0
    //   66: invokevirtual 133	bsl:b	()I
    //   69: istore_2
    //   70: iload_2
    //   71: aload_0
    //   72: invokespecial 135	bsl:i	()I
    //   75: if_icmpne +13 -> 88
    //   78: iload 4
    //   80: istore_3
    //   81: aload_0
    //   82: invokespecial 137	bsl:f	()Z
    //   85: ifeq -68 -> 17
    //   88: iload_2
    //   89: aload_0
    //   90: invokespecial 135	bsl:i	()I
    //   93: if_icmple +14 -> 107
    //   96: aload_0
    //   97: iconst_1
    //   98: putfield 89	bsl:j	Z
    //   101: iload 4
    //   103: istore_3
    //   104: goto -87 -> 17
    ...
    //   133: aload_0
    //   134: aload_0
    //   135: getfield 114	bsl:f	I
    //   138: iconst_1
    //   139: iadd
    //   140: putfield 114	bsl:f	I
    //   143: aload 6
    ...
    //   315: pop
    //   316: invokestatic 220	bue:f	()V
    //   319: goto -31 -> 288
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	322	0	this	bsl
    //   0	322	1	parambsx	bsx
    //   69	25	2	k	int
  ...
  public final java.util.List c()
  {
    ...
    //   22: areturn
    //   23: aload_0
    //   24: invokespecial 139	bsl:g	()[Ljava/io/File;
    //   27: astore 4
    //   29: iconst_0
    //   30: istore_1
    //   31: iload_1
    ...
    //   38: aload_3
    //   39: aload_0
    //   40: getfield 93	bsl:e	Lbsy;
    //   43: aload 4
    //   45: iload_1
    //   46: aaload
    //   47: invokevirtual 231	bsy:a	(Ljava/io/File;)Lbsj;
