  ...
  implements bpt
{
  ...
  public bqo(Context paramContext)
  {
    d = paramContext.getApplicationContext();
  }
  
  /* Error */
  public final bpt.a a(android.net.Uri paramUri, int paramInt)
  {
    // Byte code:
    ...
    //   5: if_icmplt +70 -> 75
    //   8: aload_0
    //   9: getfield 36	bqo:d	Landroid/content/Context;
    //   12: astore 7
    //   14: getstatic 47	bqo:a	Ljava/lang/Object;
    //   17: ifnonnull +58 -> 75
    //   20: getstatic 23	bqo:b	Ljava/lang/Object;
    //   23: astore 9
    //   25: aload 9
    //   27: monitorenter
    //   28: getstatic 47	bqo:a	Ljava/lang/Object;
    //   31: ifnonnull +41 -> 72
    //   34: aload 7
    //   36: invokestatic 52	bqp:b	(Landroid/content/Context;)Ljava/io/File;
    //   39: astore 10
    ...
    //   187: iload_2
    //   188: iload_3
    //   189: invokespecial 134	bpt$b:<init>	(Ljava/lang/String;II)V
    //   192: athrow
    //   193: astore 7
    //   195: aload 9
    //   197: monitorexit
    ...
    //   201: astore 7
    //   203: goto -128 -> 75
    //   206: getstatic 26	bqo:c	Ljava/lang/ThreadLocal;
    ...
    //   221: iload_2
    //   222: invokestatic 145	bqb:a	(I)Z
    //   225: ifne +10 -> 235
    //   228: aload_1
    //   229: ldc -109
    ...
    //   234: pop
    //   235: iload_2
    //   236: invokestatic 149	bqb:b	(I)Z
    //   239: ifne +24 -> 263
    //   242: aload_1
    ...
    //   289: invokestatic 172	bqp:a	(Ljava/lang/String;)Z
    //   292: istore 6
    //   294: new 174	bpt$a
    //   297: dup
    //   298: aload 7
    ...
    //   303: iload 6
    //   305: lload 4
    //   307: invokespecial 181	bpt$a:<init>	(Ljava/io/InputStream;ZJ)V
    //   310: areturn
