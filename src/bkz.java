...
{
  public List<blb> a = new ArrayList(1);
  ...
  /* Error */
  @cgc
  static bld a(blf paramblf, java.io.FileReader paramFileReader)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   12: aload_0
    //   13: aload_1
    //   14: invokevirtual 67	blf:a	(Ljava/io/BufferedReader;)J
    //   17: lstore_2
    //   18: lload_2
    //   19: ldc2_w 68
    //   22: lcmp
    ...
    //   28: astore_0
    //   29: aload_1
    //   30: invokestatic 74	blc:a	(Ljava/io/Closeable;)V
    //   33: aload_0
    //   34: areturn
    //   35: aload_1
    //   36: invokestatic 77	blf:b	(Ljava/io/BufferedReader;)Ljava/lang/String;
    //   39: astore 5
    //   41: aload 4
    //   43: astore_0
    //   44: aload 5
    ...
    //   69: lload_2
    //   70: aload 5
    //   72: invokespecial 95	bld:<init>	(JLjava/lang/String;)V
    //   75: astore_0
    //   76: goto -47 -> 29
    //   79: astore_0
    //   80: aload_0
    ...
    //   84: aload_1
    //   85: invokestatic 74	blc:a	(Ljava/io/Closeable;)V
    //   88: aconst_null
    //   89: areturn
    //   90: astore_0
    //   91: aload_1
    //   92: invokestatic 74	blc:a	(Ljava/io/Closeable;)V
    //   95: aload_0
    //   96: athrow
  ...
  public final void a(blb paramblb)
  {
    a.add(paramblb);
  }
}
