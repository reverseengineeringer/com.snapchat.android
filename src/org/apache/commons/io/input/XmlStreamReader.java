  ...
  extends Reader
{
  ...
  public XmlStreamReader(InputStream paramInputStream, String paramString1, boolean paramBoolean, String paramString2)
  {
    ...
    encoding = doHttpStream(paramInputStream, paramString2, paramString1, paramBoolean);
    reader = new InputStreamReader(paramString2, encoding);
  }
  ...
  public XmlStreamReader(InputStream paramInputStream, boolean paramBoolean, String paramString)
  {
    ...
    encoding = doRawStream(paramInputStream, paramString, paramBoolean);
    reader = new InputStreamReader(paramString, encoding);
  }
  ...
  public XmlStreamReader(URLConnection paramURLConnection, String paramString)
  {
    ...
    for (encoding = doHttpStream(localBOMInputStream1, localBOMInputStream2, paramString, true);; encoding = doRawStream(localBOMInputStream1, localBOMInputStream2, true))
    {
      reader = new InputStreamReader(localBOMInputStream2, encoding);
      return;
    }
  }
  ...
  {
    return reader.read(paramArrayOfChar, paramInt1, paramInt2);
  }
}
