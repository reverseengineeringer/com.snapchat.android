...
public class EndianUtils
{
  ...
  {
    return (((paramArrayOfByte[(paramInt + 0)] & 0xFF) << 0) + ((paramArrayOfByte[(paramInt + 1)] & 0xFF) << 8) + ((paramArrayOfByte[(paramInt + 2)] & 0xFF) << 16) + ((paramArrayOfByte[(paramInt + 3)] & 0xFF) << 24) & 0xFFFFFFFF) + (((paramArrayOfByte[(paramInt + 4)] & 0xFF) << 0) + ((paramArrayOfByte[(paramInt + 5)] & 0xFF) << 8) + ((paramArrayOfByte[(paramInt + 6)] & 0xFF) << 16) + ((paramArrayOfByte[(paramInt + 7)] & 0xFF) << 24) << 32);
  }
  ...
  public static long readSwappedUnsignedInteger(InputStream paramInputStream)
  {
    ...
    return (((i & 0xFF) << 0) + ((j & 0xFF) << 8) + ((k & 0xFF) << 16) & 0xFFFFFFFF) + ((m & 0xFF) << 24);
  }
  
  public static long readSwappedUnsignedInteger(byte[] paramArrayOfByte, int paramInt)
  {
    return (((paramArrayOfByte[(paramInt + 0)] & 0xFF) << 0) + ((paramArrayOfByte[(paramInt + 1)] & 0xFF) << 8) + ((paramArrayOfByte[(paramInt + 2)] & 0xFF) << 16) & 0xFFFFFFFF) + ((paramArrayOfByte[(paramInt + 3)] & 0xFF) << 24);
  }
