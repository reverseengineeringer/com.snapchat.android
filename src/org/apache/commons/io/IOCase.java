  ...
  implements Serializable
{
  ...
  public final int checkCompareTo(String paramString1, String paramString2)
  {
  ...
  public final boolean checkEndsWith(String paramString1, String paramString2)
  {
  ...
  public final boolean checkEquals(String paramString1, String paramString2)
  {
    if ((paramString1 == null) || (paramString2 == null)) {
      throw new NullPointerException("The strings must not be null");
    }
  ...
  public final int checkIndexOf(String paramString1, int paramInt, String paramString2)
  {
  ...
  public final boolean checkRegionMatches(String paramString1, int paramInt, String paramString2)
  {
    if (!sensitive) {}
    for (boolean bool = true;; bool = false) {
  ...
  public final boolean checkStartsWith(String paramString1, String paramString2)
  {
    if (!sensitive) {}
    for (boolean bool = true;; bool = false) {
