    ...
    for (i = 0;; i = 1)
    {
      ...
      while (j < k)
      {
        ...
        if (localObject[j] == paramChar)
        {
          m = k;
          n = j;
          if (localObject[(j - 1)] == paramChar)
          {
            System.arraycopy(localObject, j, localObject, j - 1, k - j);
            m = k - 1;
            n = j - 1;
          }
        }
        ...
        if (localObject[j] == paramChar)
        {
          ...
          if (localObject[(j - 1)] == '.') {
            ...
            else
            {
              ...
              System.arraycopy(localObject, j + 1, localObject, j - 1, k - j);
              m = k - 2;
              n = j - 1;
              i1 = i;
            }
