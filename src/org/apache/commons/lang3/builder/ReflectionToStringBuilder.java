  ...
  extends ToStringBuilder
{
  ...
  protected boolean accept(Field paramField)
  {
    ...
    while (((Modifier.isTransient(paramField.getModifiers())) && (!isAppendTransients())) || ((Modifier.isStatic(paramField.getModifiers())) && (!isAppendStatics())) || ((excludeFieldNames != null) && (Arrays.binarySearch(excludeFieldNames, paramField.getName()) >= 0))) {
      return false;
    }
    return true;
  }
  ...
  {
    appendStatics = paramBoolean;
  }
  
  public void setAppendTransients(boolean paramBoolean)
  {
    appendTransients = paramBoolean;
  }
  ...
  public ReflectionToStringBuilder setExcludeFieldNames(String... paramVarArgs)
  {
    ...
    excludeFieldNames = toNoNullStringArray(paramVarArgs);
