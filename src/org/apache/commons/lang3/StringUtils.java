...
public class StringUtils
{
  ...
  public static double getJaroWinklerDistance(CharSequence paramCharSequence1, CharSequence paramCharSequence2)
  {
    ...
    return Math.round((d + commonPrefixLength(paramCharSequence1, paramCharSequence2) * 0.1D * (1.0D - d)) * 100.0D) / 100.0D;
  }
  ...
  public static int getLevenshteinDistance(CharSequence paramCharSequence1, CharSequence paramCharSequence2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (i1 > 1)
        {
          paramCharSequence1[(i1 - 1)] = Integer.MAX_VALUE;
          n = i1;
        }
        if (n <= m)
        {
  ...
  public static int indexOfAny(CharSequence paramCharSequence, CharSequence... paramVarArgs)
  {
    ...
    if (j < m)
    {
      ...
      int k = CharSequenceUtils.indexOf(paramCharSequence, localCharSequence, 0);
      if ((k == -1) || (k >= i)) {
        break label80;
      }
      i = k;
  ...
  public static int indexOfDifference(CharSequence paramCharSequence1, CharSequence paramCharSequence2)
  {
    ...
    do
    {
      do
      {
        ...
        j = k;
        while ((j < paramCharSequence1.length()) && (j < paramCharSequence2.length()) && (paramCharSequence1.charAt(j) == paramCharSequence2.charAt(j))) {
          j += 1;
        }
        i = j;
      } while (j < paramCharSequence2.length());
      i = j;
    } while (j < paramCharSequence1.length());
    return -1;
  }
        ...
        do
        {
          ...
          if (m < i4)
          {
            ...
            for (;;)
            {
              ...
              m = i3;
              break;
              k = Math.min(paramVarArgs[m].length(), i1);
              n = Math.max(paramVarArgs[m].length(), n);
              j = i;
              i1 = 0;
              i = k;
              k = i1;
  ...
  private static String replaceEach(String paramString, String[] paramArrayOfString1, String[] paramArrayOfString2, boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        paramInt = paramArrayOfString2.length;
        if (i3 != paramInt) {
          throw new IllegalArgumentException("Search and Replace array lengths don't match: " + i3 + " vs " + paramInt);
        }
        localObject = new boolean[i3];
        paramInt = -1;
        int i = -1;
        int j = 0;
        int n;
          ...
          if (localObject[j] == 0)
          {
            ...
            if (paramArrayOfString1[j] != null)
            {
              ...
              if (!paramArrayOfString1[j].isEmpty())
              {
                ...
                {
                  i1 = paramString.indexOf(paramArrayOfString1[j]);
                  if (i1 != -1) {
                    break label236;
                  }
                  localObject[j] = 1;
        ...
        while (j < paramArrayOfString1.length)
        {
          ...
          if (paramArrayOfString1[j] != null)
          {
            ...
            if (paramArrayOfString2[j] != null)
            {
              i1 = paramArrayOfString2[j].length() - paramArrayOfString1[j].length();
              n = m;
              if (i1 > 0) {
                n = m + i1 * 3;
              }
        ...
        StringBuilder localStringBuilder = new StringBuilder(Math.min(m, paramString.length() / 5) + paramString.length());
        j = i;
        m = 0;
        i = paramInt;
        for (paramInt = m; i != -1; paramInt = i1)
        {
          while (paramInt < i)
          {
          ...
          i1 = i + paramArrayOfString1[j].length();
          i = -1;
          j = -1;
          paramInt = 0;
          if (paramInt < i3)
          {
            ...
            if (localObject[paramInt] == 0)
            {
              m = j;
              n = i;
              if (paramArrayOfString1[paramInt] != null)
              {
                m = j;
                n = i;
                if (!paramArrayOfString1[paramInt].isEmpty())
                {
                  m = j;
                  n = i;
                  if (paramArrayOfString2[paramInt] != null)
                  {
                    i2 = paramString.indexOf(paramArrayOfString1[paramInt], i1);
                    if (i2 != -1) {
                      break label584;
                    }
  ...
  private static double score(CharSequence paramCharSequence1, CharSequence paramCharSequence2)
  {
    ...
    String str1;
    String str2;
    for (paramCharSequence2 = paramCharSequence2.toString().toLowerCase();; paramCharSequence2 = str1)
    {
    ...
    double d = str1.length() / paramCharSequence2.length();
    return (str2.length() / paramCharSequence1.length() + d + (str1.length() - i) / str1.length()) / 3.0D;
  }
  ...
  private static String[] splitByCharacterType(String paramString, boolean paramBoolean)
  {
    ...
    int m = Character.getType(paramString[0]);
    int k = 0;
    int j = 1;
    if (j < paramString.length)
    {
      int i1 = Character.getType(paramString[j]);
      int n = m;
      int i = k;
      if (i1 != m)
      {
        if ((!paramBoolean) || (i1 != 2) || (m != 1)) {
          break label147;
        }
        m = j - 1;
        i = k;
        if (m != k) {
          localArrayList.add(new String(paramString, k, m - k));
        }
      }
      for (i = m;; i = j)
      {
  ...
  private static int transpositions(CharSequence paramCharSequence1, CharSequence paramCharSequence2)
  {
    int i = 0;
    int k;
    for (int j = 0; i < paramCharSequence1.length(); j = k)
    {
      k = j;
