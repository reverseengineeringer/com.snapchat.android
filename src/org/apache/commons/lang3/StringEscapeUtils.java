...
public class StringEscapeUtils
{
  ...
  static
  {
    ESCAPE_ECMASCRIPT = new AggregateTranslator(new CharSequenceTranslator[] { new LookupTranslator(new String[][] { { "'", "\\'" }, { "\"", "\\\"" }, { "\\", "\\\\" }, { "/", "\\/" } }), new LookupTranslator(EntityArrays.JAVA_CTRL_CHARS_ESCAPE()), JavaUnicodeEscaper.outsideOf(32, 127) });
    ...
    Object localObject1 = new LookupTranslator(EntityArrays.BASIC_ESCAPE());
    Object localObject2 = new LookupTranslator(EntityArrays.APOS_ESCAPE());
    Object localObject3 = { "\020", "" };
    String[] arrayOfString = { "\031", "" };
    ESCAPE_XML10 = new AggregateTranslator(new CharSequenceTranslator[] { localObject1, localObject2, new LookupTranslator(new String[][] { { "\000", "" }, { "\001", "" }, { "\002", "" }, { "\003", "" }, { "\004", "" }, { "\005", "" }, { "\006", "" }, { "\007", "" }, { "\b", "" }, { "\013", "" }, { "\f", "" }, { "\016", "" }, { "\017", "" }, localObject3, { "\021", "" }, { "\022", "" }, { "\023", "" }, { "\024", "" }, { "\025", "" }, { "\026", "" }, { "\027", "" }, { "\030", "" }, arrayOfString, { "\032", "" }, { "\033", "" }, { "\034", "" }, { "\035", "" }, { "\036", "" }, { "\037", "" }, { "￾", "" }, { "￿", "" } }), NumericEntityEscaper.between(127, 132), NumericEntityEscaper.between(134, 159), new UnicodeUnpairedSurrogateRemover() });
    ...
    localObject1 = new AggregateTranslator(new CharSequenceTranslator[] { localObject1, localObject2, localObject3, new LookupTranslator(new String[][] { { "\\\\", "\\" }, arrayOfString, { "\\'", "'" }, { "\\", "" } }) });
