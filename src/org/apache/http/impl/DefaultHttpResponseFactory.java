  ...
  implements HttpResponseFactory
{
  ...
  public HttpResponse newHttpResponse(ProtocolVersion paramProtocolVersion, int paramInt, HttpContext paramHttpContext)
  {
    ...
    return new BasicHttpResponse(new BasicStatusLine(paramProtocolVersion, paramInt, reasonCatalog.getReason(paramInt, paramHttpContext)), reasonCatalog, paramHttpContext);
  }
