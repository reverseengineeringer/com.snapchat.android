  ...
  extends AsyncTask<Void, Void, Boolean>
{
  ...
  public bwa(Context paramContext, Handler paramHandler, String paramString, int paramInt, Map<String, String> paramMap)
  {
    a = paramContext;
    b = paramHandler;
    f = paramString;
  ...
  {
    // Byte code:
    //   0: getstatic 57	bwf$a:a	Lbwf;
    //   3: getfield 62	bwf:a	Lorg/apache/http/client/HttpClient;
    //   6: astore_3
    //   7: aload_0
    //   8: getfield 33	bwa:e	I
    //   11: istore_1
    //   12: aload_0
    //   13: getfield 35	bwa:g	Ljava/util/Map;
    //   16: astore_2
    //   17: iload_1
    //   18: iconst_1
    ...
    //   134: dup
    //   135: aload_0
    //   136: getfield 31	bwa:f	Ljava/lang/String;
    ...
    //   178: aload_0
    //   179: aload_2
    //   180: invokespecial 163	bwa:a	(Ljava/lang/String;)Z
    ...
    //   253: invokestatic 195	bwe:a	([B)Ljava/lang/String;
    ...
    //   267: dup
    //   268: aload_0
    //   269: getfield 31	bwa:f	Ljava/lang/String;
    ...
    //   336: aload_0
    //   337: getfield 31	bwa:f	Ljava/lang/String;
  ...
  private boolean a(String paramString)
  {
    ...
    try
    {
      ...
      if (e == 1)
      {
        ...
        bwi.a(localSharedPreferences.edit().putString("iuid", paramString));
        return true;
      }
      if (e == 2)
      {
        ...
        bwi.a(localSharedPreferences.edit().putString("auid", paramString));
        return true;
      }
      if (e == 3)
      {
        ...
        bwi.a(localSharedPreferences.edit().remove("iuid").remove("auid"));
        return false;
      }
    }
