  ...
  extends AsyncTask<Void, Integer, Long>
{
  ...
  public bvy(Context paramContext, String paramString, bvp parambvp)
  {
    a = paramContext;
    c = paramString;
  ...
  protected void a(Long paramLong)
  {
    ...
    catch (Exception localException)
    {
      try
      {
        ...
        localBuilder.setTitle(bvi.a(b, 256));
        if (g == null) {}
        for (paramLong = bvi.a(b, 257);; paramLong = g)
        {
          localBuilder.setMessage(paramLong);
          localBuilder.setNegativeButton(bvi.a(b, 258), new DialogInterface.OnClickListener()
          {
          ...
          localBuilder.setPositiveButton(bvi.a(b, 259), new DialogInterface.OnClickListener()
          {
            public final void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
            {
