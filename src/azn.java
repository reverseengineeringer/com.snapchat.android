...
public final class azn
  extends Observable
{
  private static final azn INSTANCE = new azn();
  ...
  public final void a(String paramString)
  {
    ...
    SharedPreferences.Editor localEditor = mSharedPreferences.edit();
    localEditor.putString(SharedPreferenceKey.DEVELOPER_OPTIONS_CUSTOM_DISCOVER_ENDPOINT.getKey(), paramString);
    localEditor.apply();
    setChanged();
    notifyObservers(SharedPreferenceKey.DEVELOPER_OPTIONS_CUSTOM_DISCOVER_ENDPOINT.getKey());
  }
  ...
  public final String b()
  {
    ...
    return mSharedPreferences.getString(SharedPreferenceKey.DEVELOPER_OPTIONS_CUSTOM_DISCOVER_ENDPOINT.getKey(), null);
  }
