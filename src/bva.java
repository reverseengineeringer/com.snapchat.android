  ...
  extends HttpsURLConnection
{
  ...
  public bva(HttpsURLConnection paramHttpsURLConnection, bum parambum, btx parambtx)
  {
    super(paramHttpsURLConnection.getURL());
    a = parambum;
    b = paramHttpsURLConnection;
    d = parambtx;
    c = new btc(paramHttpsURLConnection.getURL());
    paramHttpsURLConnection = b.getSSLSocketFactory();
    if ((paramHttpsURLConnection instanceof brc))
    {
      paramHttpsURLConnection = (brc)paramHttpsURLConnection;
  ...
  private void b()
  {
    ...
    //   3: istore_1
    //   4: aload_0
    //   5: getfield 34	bva:e	Z
    //   8: ifne +151 -> 159
    //   11: aload_0
    //   12: iconst_1
    //   13: putfield 34	bva:e	Z
    //   16: aload_0
    //   17: getfield 30	bva:c	Lbtc;
    //   20: invokevirtual 94	btc:d	()V
    //   23: aload_0
    //   24: getfield 28	bva:b	Ljavax/net/ssl/HttpsURLConnection;
    //   27: invokevirtual 114	javax/net/ssl/HttpsURLConnection:getHeaderFields	()Ljava/util/Map;
    //   30: ifnull +100 -> 130
    //   33: new 116	bux
    //   36: dup
    //   37: aload_0
    //   38: getfield 28	bva:b	Ljavax/net/ssl/HttpsURLConnection;
    //   41: invokevirtual 114	javax/net/ssl/HttpsURLConnection:getHeaderFields	()Ljava/util/Map;
    //   44: invokespecial 119	bux:<init>	(Ljava/util/Map;)V
    //   47: astore 7
    //   49: aload 7
    //   51: ldc 121
    //   53: invokevirtual 124	bux:b	(Ljava/lang/String;)I
    //   56: istore_2
    //   57: iload_2
    //   58: iconst_m1
    //   59: if_icmpeq +14 -> 73
    //   62: aload_0
    //   63: getfield 30	bva:c	Lbtc;
    //   66: iload_2
    //   67: i2l
    //   68: invokevirtual 127	btc:b	(J)V
    //   71: iconst_1
    //   72: istore_1
    //   73: aload 7
    //   75: ldc -127
    //   77: invokevirtual 132	bux:a	(Ljava/lang/String;)J
    //   80: lstore_3
    //   81: aload 7
    //   83: ldc -122
    //   85: invokevirtual 132	bux:a	(Ljava/lang/String;)J
    //   88: lstore 5
    //   90: iload_1
    //   91: istore_2
    //   92: lload_3
    ...
    //   108: ifeq +22 -> 130
    //   111: aload_0
    //   112: getfield 30	bva:c	Lbtc;
    //   115: lload_3
    //   116: invokevirtual 138	btc:e	(J)V
    //   119: aload_0
    //   120: getfield 30	bva:c	Lbtc;
    //   123: lload 5
    //   125: invokevirtual 140	btc:f	(J)V
    //   128: iload_1
    //   129: istore_2
    //   130: aload_0
    //   131: getfield 30	bva:c	Lbtc;
    //   134: aload_0
    //   135: getfield 28	bva:b	Ljavax/net/ssl/HttpsURLConnection;
    //   138: invokevirtual 144	javax/net/ssl/HttpsURLConnection:getResponseCode	()I
    //   141: putfield 147	btc:e	I
    //   144: iload_2
    //   145: ifeq +14 -> 159
    //   148: aload_0
    //   149: getfield 26	bva:a	Lbum;
    //   152: aload_0
    //   153: getfield 30	bva:c	Lbtc;
    //   156: invokevirtual 108	bum:a	(Lbtc;)V
    //   159: return
    //   160: astore 7
    //   162: aload 7
    //   164: athrow
    //   165: astore 7
    //   167: aload 7
    //   169: invokestatic 92	bue:a	(Ljava/lang/Throwable;)V
    //   172: return
    //   173: astore 7
    //   175: goto -31 -> 144
  ...
  public final InputStream getErrorStream()
  {
    ...
    if (localInputStream != null) {
      try
      {
        bvb localbvb = new bvb(localInputStream, a, c);
        return localbvb;
      }
      catch (ThreadDeath localThreadDeath)
      {
  ...
  public final InputStream getInputStream()
  {
    // Byte code:
    //   0: aload_0
    //   1: invokespecial 178	bva:a	()V
    //   4: aload_0
    //   5: getfield 28	bva:b	Ljavax/net/ssl/HttpsURLConnection;
    //   8: invokevirtual 248	javax/net/ssl/HttpsURLConnection:getInputStream	()Ljava/io/InputStream;
    //   11: astore_1
    //   12: aload_0
    //   13: invokespecial 182	bva:b	()V
    //   16: aload_1
    //   17: ifnull +38 -> 55
    //   20: new 214	bvb
    //   23: dup
    //   24: aload_1
    //   25: aload_0
    //   26: getfield 26	bva:a	Lbum;
    //   29: aload_0
    //   30: getfield 30	bva:c	Lbtc;
    //   33: invokespecial 217	bvb:<init>	(Ljava/io/InputStream;Lbum;Lbtc;)V
    //   36: astore_2
    //   37: aload_2
    //   38: areturn
    //   39: astore_1
    //   40: aload_0
    //   41: aload_1
    //   42: invokespecial 183	bva:a	(Ljava/lang/Throwable;)V
    //   45: aload_1
    //   46: athrow
    //   47: astore_1
    //   48: aload_1
    ...
    //   50: astore_2
    //   51: aload_2
    //   52: invokestatic 92	bue:a	(Ljava/lang/Throwable;)V
    //   55: aload_1
    //   56: areturn
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public final OutputStream getOutputStream()
  {
    ...
    if (localOutputStream != null) {
      try
      {
        bvc localbvc = new bvc(localOutputStream, c);
        return localbvc;
      }
      catch (ThreadDeath localThreadDeath)
      {
  ...
  public final void setSSLSocketFactory(SSLSocketFactory paramSSLSocketFactory)
  {
    ...
    try
    {
      if ((paramSSLSocketFactory instanceof brc)) {
