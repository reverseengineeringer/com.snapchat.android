  ...
  extends bss
{
  ...
  public bst(Process paramProcess, ConditionVariable paramConditionVariable, int paramInt)
  {
  ...
  public final void a()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 40	bst:f	I
    //   4: getstatic 49	bst$a:a	I
    //   7: if_icmpne +112 -> 119
    //   10: aload_0
    //   11: getfield 33	bst:d	Ljava/lang/Process;
    //   14: invokevirtual 55	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   17: astore_1
    //   18: aload_0
    //   19: aload_1
    //   20: putfield 29	bst:b	Ljava/io/InputStream;
    //   23: aload_0
    ...
    //   31: dup
    //   32: aload_0
    //   33: getfield 29	bst:b	Ljava/io/InputStream;
    ...
    //   42: putfield 27	bst:a	Ljava/io/BufferedReader;
    //   45: aload_0
    //   46: getfield 27	bst:a	Ljava/io/BufferedReader;
    //   49: invokevirtual 69	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   52: astore_1
    //   53: aload_1
    //   54: ifnull +27 -> 81
    //   57: aload_0
    //   58: getfield 38	bst:e	Ljava/lang/StringBuilder;
    //   61: aload_1
    ...
    //   71: goto -26 -> 45
    //   74: astore_1
    //   75: invokestatic 80	btd:b	()V
    //   78: invokestatic 82	btd:c	()V
    //   81: aload_0
    //   82: getfield 27	bst:a	Ljava/io/BufferedReader;
    //   85: invokevirtual 85	java/io/BufferedReader:close	()V
    //   88: aload_0
    //   89: getfield 29	bst:b	Ljava/io/InputStream;
    //   92: invokevirtual 88	java/io/InputStream:close	()V
    //   95: aload_0
    //   96: aconst_null
    //   97: putfield 27	bst:a	Ljava/io/BufferedReader;
    //   100: aload_0
    //   101: invokespecial 89	bst:c	()V
    //   104: aload_0
    //   105: getfield 31	bst:c	Landroid/os/ConditionVariable;
    //   108: ifnull +10 -> 118
    //   111: aload_0
    //   112: getfield 31	bst:c	Landroid/os/ConditionVariable;
    //   115: invokevirtual 94	android/os/ConditionVariable:open	()V
    //   118: return
    //   119: aload_0
    //   120: getfield 33	bst:d	Ljava/lang/Process;
    ...
    //   150: pop
    //   151: invokestatic 80	btd:b	()V
    //   154: invokestatic 82	btd:c	()V
    //   157: goto -76 -> 81
    //   160: astore_1
    //   161: invokestatic 80	btd:b	()V
    //   164: invokestatic 82	btd:c	()V
    //   167: goto -79 -> 88
    //   170: astore_1
    //   171: aload_0
    //   172: aconst_null
    //   173: putfield 27	bst:a	Ljava/io/BufferedReader;
    //   176: aload_1
    //   177: athrow
    //   178: astore_1
    //   179: invokestatic 80	btd:b	()V
    //   182: invokestatic 82	btd:c	()V
    //   185: goto -90 -> 95
  ...
  public final StringBuilder b()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 42	bst:g	Z
    //   6: ifeq +12 -> 18
    //   9: aload_0
    //   10: getfield 38	bst:e	Ljava/lang/StringBuilder;
    //   13: astore_1
    //   14: aload_0
    //   15: monitorexit
    //   16: aload_1
