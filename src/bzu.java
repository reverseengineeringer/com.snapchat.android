  ...
  implements bzv, bzw, Cloneable
{
  ...
  private bzu s()
  {
    ...
    g = localcag3;
    f = localcag3;
    for (localcag1 = a.f; localcag1 != a; localcag1 = f) {
      a.g.a(new cag(localcag1));
    }
    b = b;
    return localbzu;
  }
  ...
  {
    cal.a(paramArrayOfByte.length, paramInt1, paramInt2);
    cag localcag = a;
    if (localcag == null) {
      paramInt1 = -1;
    }
  ...
  public final bzu a(bzu parambzu, long paramLong1, long paramLong2)
  {
    if (parambzu == null) {
      throw new IllegalArgumentException("out == null");
    }
    cal.a(b, paramLong1, paramLong2);
    if (paramLong2 == 0L) {
      return this;
    }
    b += paramLong2;
    ...
    long l1;
    long l2;
    for (cag localcag1 = a;; localcag1 = f)
    {
      localcag2 = localcag1;
      l1 = paramLong1;
      l2 = paramLong2;
  ...
  public final bzu a(bzx parambzx)
  {
    if (parambzx == null) {
  ...
  public final bzu a(String paramString)
  {
    if (paramString == null) {
  ...
  public final bzu a(byte[] paramArrayOfByte)
  {
  ...
  public final void a_(bzu parambzu, long paramLong)
  {
    ...
    cag localcag2 = new cag(localcag1);
    c = (b + i);
    b = (i + b);
    g.a(localcag2);
    a = localcag2;
  ...
  {
    cal.a(b, paramLong, 1L);
    for (cag localcag = a;; localcag = f)
    {
      int i = c - b;
      if (paramLong < i) {
  ...
  public final bzu b(int paramInt)
  {
    cag localcag = d(2);
    byte[] arrayOfByte = a;
    int i = c;
  ...
  public final bzu b(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    if (paramArrayOfByte == null) {
      throw new IllegalArgumentException("source == null");
    }
  ...
  public final bzu c(int paramInt)
  {
    cag localcag = d(4);
    byte[] arrayOfByte = a;
    int j = c;
  ...
  {
    return new bzx(e(paramLong));
  }
  
  public final void close() {}
  
  final cag d(int paramInt)
  {
  ...
  public final bzu g(long paramLong)
  {
    if (paramLong == 0L) {
      return a(48);
    }
  ...
  public final bzu h(long paramLong)
  {
    if (paramLong == 0L) {
      return a(48);
    }
  ...
  public final long k()
  {
    ...
    if (m < i2)
    {
      ...
      if ((n >= 48) && (n <= 57))
      {
        ...
        {
          localObject = new bzu().g(l1).a(n);
          if (k == 0) {
            ((bzu)localObject).f();
          }
          throw new NumberFormatException("Number too large: " + ((bzu)localObject).r());
        }
        l1 = l1 * 10L + i1;
      }
      for (;;)
  ...
  public final String n()
  {
    ...
    {
      bzu localbzu = new bzu();
      a(localbzu, 0L, Math.min(32L, b));
      throw new EOFException("\\n not found: size=" + b + " content=" + localbzu.m().b() + "...");
    }
    return d(l);
  }
  ...
  public final String toString()
  {
    ...
    {
      localObject = s().m();
      return String.format("Buffer[size=%s data=%s]", new Object[] { Long.valueOf(b), ((bzx)localObject).b() });
    }
    try
    {
      ...
      localObject = String.format("Buffer[size=%s md5=%s]", new Object[] { Long.valueOf(b), bzx.a(localMessageDigest.digest()).b() });
