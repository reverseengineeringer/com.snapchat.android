...
{
  public static int a(@chc Editable paramEditable)
  {
    int i = 0;
  ...
  public static int a(@chc EditText paramEditText)
  {
    Editable localEditable = paramEditText.getText();
    yq.a locala = a(localEditable.toString(), paramEditText.getSelectionEnd());
  ...
  @chd
  public static yq.a a(@chc String paramString, int paramInt)
  {
    yq.a locala;
    ...
    for (;;)
    {
      ...
      if (k > j)
      {
        locala = new yq.a(paramInt, paramInt);
        break;
      }
      locala = new yq.a(k, j);
      break;
  ...
  public static void a(@chc EditText paramEditText, int paramInt)
  {
    Editable localEditable = paramEditText.getText();
    ...
    for (;;)
    {
      ...
      paramInt = (int)(((Rect)localObject3).width() + awf.a(8.0F, SnapchatApplication.b()));
      float f = awf.a(24.0F, SnapchatApplication.b());
  ...
  @chc
  private static String b(@chc String paramString)
  {
    String str;
  ...
  @chc
  public static List<ImageSpan> b(@chc Editable paramEditable)
  {
    return Arrays.asList(paramEditable.getSpans(0, paramEditable.length(), ImageSpan.class));
  }
  
  @chd
  public static yq.a b(@chc String paramString, int paramInt)
  {
  ...
  private static int c(@chc String paramString)
  {
    int j = 0;
  ...
  private static String d(@chc String paramString)
  {
    return paramString.replaceAll("(?i)PI", "3.14").replaceAll("(?i)E", "2.72");
  }
  
  private static int e(@chc String paramString)
  {
    int i = 1;
    ...
    bya localbya = new bya('\'', false, false, false, false);
    try
    {
      double d = Math.round(Double.parseDouble(localbya.a(paramString, true)) * 100.0D);
      if (d > 2.147483647E9D) {
    ...
    catch (NumberFormatException paramString) {}catch (bxy paramString) {}
    return -1;
  }
