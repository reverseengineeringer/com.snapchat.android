...
public class btv
  extends btt
{
  private static final String a = btv.class.getName();
  private bth b;
  private btn c;
  private boolean d;
  private btj e;
  
  public btv(bth parambth, btn parambtn, btj parambtj)
  {
    this(parambth, parambtn, false, parambtj);
  }
  
  public btv(bth parambth, btn parambtn, boolean paramBoolean, btj parambtj)
  {
    b = parambth;
    c = parambtn;
    d = paramBoolean;
  ...
  public final void a()
  {
    ...
    //   227: istore_1
    //   228: aload_0
    //   229: getfield 38	btv:d	Z
    //   232: ifeq +185 -> 417
    //   235: aload 5
    //   237: invokestatic 210	btv:a	(Ljava/net/URLConnection;)Lorg/json/JSONObject;
    //   240: astore_3
    //   241: iconst_0
    //   242: istore_2
    //   243: aload 5
    ...
    //   248: aload_0
    //   249: getfield 40	btv:e	Lbtj;
    //   252: ifnull +171 -> 423
    //   255: aload_0
    //   256: getfield 40	btv:e	Lbtj;
    //   259: iload_2
    //   260: iload_1
    //   261: aload_3
    ...
    //   287: pop
    //   288: invokestatic 185	bue:b	()V
    //   291: invokestatic 229	bue:c	()V
    //   294: iconst_0
    //   295: istore_2
    //   296: aload 4
    //   298: astore_3
    ...
    //   352: pop
    //   353: invokestatic 185	bue:b	()V
    //   356: invokestatic 229	bue:c	()V
    //   359: iconst_0
    //   360: istore_2
    //   361: aload 4
    //   363: astore_3
    ...
    //   386: pop
    //   387: invokestatic 185	bue:b	()V
    //   390: iconst_0
    //   391: istore_2
    //   392: invokestatic 229	bue:c	()V
    //   395: aload 4
    //   397: astore_3
    //   398: goto -155 -> 243
    //   401: astore_3
