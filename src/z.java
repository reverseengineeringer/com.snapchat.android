...
public final class z
{
  ...
  public static void a(Context paramContext)
  {
    ...
    try
    {
      ...
      List localList = aa.a(paramContext, localApplicationInfo, localFile, false);
      if (a(localList)) {
      ...
      {
        return;
        paramContext = aa.a(paramContext, localApplicationInfo, localFile, true);
        if (!a(paramContext)) {
          break;
        }
  ...
  private static void a(ClassLoader paramClassLoader, File paramFile, List<File> paramList)
  {
    ...
    z.a.a(paramClassLoader, paramList);
  }
