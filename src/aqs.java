  ...
  extends RecyclerView.s
{
  ...
  public aqs(View paramView)
  {
    super(paramView);
    k = null;
  }
  
  public aqs(aqq paramaqq, Context paramContext, View paramView)
  {
    super(paramView);
    n = paramaqq;
    k = paramContext;
    l = ((ImageView)paramView.findViewById(2131362594));
    paramaqq = (FrameLayout)paramView.findViewById(2131362592);
    o = new aqs.a();
    paramaqq.setOnClickListener(o);
  }
