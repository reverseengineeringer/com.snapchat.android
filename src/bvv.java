...
{
  public Queue<bvv.b> a = new LinkedList();
  boolean b = false;
  ...
  public final void a()
  {
    ...
    {
      return;
      localObject = (bvv.b)a.peek();
    } while (localObject == null);
    Object localObject = new bvv.c((bvv.b)localObject, new Handler()
    {
      public final void handleMessage(final Message paramAnonymousMessage)
      {
        paramAnonymousMessage = (bvv.b)a.poll();
        if (!c)
        {
          i = d - 1;
          d = i;
    ...
    b = true;
    bwd.a((AsyncTask)localObject);
  }
  
  public static final class a
  {
    public static final bvv a = new bvv((byte)0);
  }
  ...
  public static final class b
  {
    ...
    private b(bvs parambvs, AttachmentView paramAttachmentView)
    {
      a = parambvs;
    ...
    extends AsyncTask<Void, Integer, Boolean>
  {
    ...
    public c(bvv.b paramb, Handler paramHandler)
    {
      a = paramb;
      b = paramHandler;
      c = buz.a();
    ...
    private Boolean a()
    {
      ...
      if (((File)localObject).exists())
      {
        ...
        {
          localObject = ((File)localObject).listFiles(new bvs.1(localbvs));
          i = j;
          if (localObject != null)
          {
            i = j;
    ...
    private void b()
    {
      try
      {
        ...
        e = bwh.a(new File(c, (String)localObject1));
        int i;
        if (e == 1)
        {
        ...
        for (int j = ((AttachmentView)localObject2).getMaxHeightLandscape();; j = ((AttachmentView)localObject2).getMaxHeightPortrait())
        {
          ...
          inSampleSize = bwh.a((BitmapFactory.Options)localObject2, i, j);
