  ...
  extends TypeAdapter<Date>
{
  ...
  /* Error */
  public final Date read(com.google.gson.stream.JsonReader paramJsonReader)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   25: dup
    //   26: aload_0
    //   27: getfield 29	com/google/gson/internal/bind/SqlDateTypeAdapter:a	Ljava/text/DateFormat;
    //   30: aload_1
  ...
  {
    if (paramDate == null) {}
    for (paramDate = null;; paramDate = a.format(paramDate)) {
      try
      {
