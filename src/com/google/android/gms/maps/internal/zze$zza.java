  ...
  implements zze
{
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
  {
    ...
    paramParcel1 = zza(zzl.zza.zzcb(paramParcel1.readStrongBinder()), paramParcel1.readInt(), paramParcel1.readInt());
    ...
    implements zze
  {
    ...
    /* Error */
    public Bitmap zza(com.google.android.gms.maps.model.internal.zzl paramzzl, int paramInt1, int paramInt2)
    {
      // Byte code:
      //   0: aconst_null
      //   1: astore 4
