...
public final class GoogleMap
{
  ...
  {
    zzapq = ((IGoogleMapDelegate)zzx.zzl(paramIGoogleMapDelegate));
  }
  ...
  public final Circle addCircle(CircleOptions paramCircleOptions)
  {
    try
    {
      paramCircleOptions = new Circle(zzapq.addCircle(paramCircleOptions));
  ...
  public final GroundOverlay addGroundOverlay(GroundOverlayOptions paramGroundOverlayOptions)
  {
    try
    {
      paramGroundOverlayOptions = zzapq.addGroundOverlay(paramGroundOverlayOptions);
  ...
  public final Marker addMarker(MarkerOptions paramMarkerOptions)
  {
    try
    {
      paramMarkerOptions = zzapq.addMarker(paramMarkerOptions);
  ...
  public final Polygon addPolygon(PolygonOptions paramPolygonOptions)
  {
    try
    {
      paramPolygonOptions = new Polygon(zzapq.addPolygon(paramPolygonOptions));
  ...
  public final Polyline addPolyline(PolylineOptions paramPolylineOptions)
  {
    try
    {
      paramPolylineOptions = new Polyline(zzapq.addPolyline(paramPolylineOptions));
  ...
  public final TileOverlay addTileOverlay(TileOverlayOptions paramTileOverlayOptions)
  {
    try
    {
      paramTileOverlayOptions = zzapq.addTileOverlay(paramTileOverlayOptions);
  ...
  public final void animateCamera(CameraUpdate paramCameraUpdate)
  {
    try
    {
      zzapq.animateCamera(paramCameraUpdate.zzqe());
      return;
    }
  ...
  public final void animateCamera(CameraUpdate paramCameraUpdate, int paramInt, CancelableCallback paramCancelableCallback)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 104	com/google/android/gms/maps/GoogleMap:zzapq	Lcom/google/android/gms/maps/internal/IGoogleMapDelegate;
    //   4: astore 4
    //   6: aload_1
    //   7: invokevirtual 180	com/google/android/gms/maps/CameraUpdate:zzqe	()Lcom/google/android/gms/dynamic/zzd;
    //   10: astore 5
    //   12: aload_3
    //   13: ifnonnull +17 -> 30
    //   16: aconst_null
  ...
  public final void animateCamera(CameraUpdate paramCameraUpdate, CancelableCallback paramCancelableCallback)
  {
    ...
    //   4: astore_3
    //   5: aload_1
    //   6: invokevirtual 180	com/google/android/gms/maps/CameraUpdate:zzqe	()Lcom/google/android/gms/dynamic/zzd;
    //   9: astore 4
    //   11: aload_2
    //   12: ifnonnull +15 -> 27
    //   15: aconst_null
  ...
  public final CameraPosition getCameraPosition()
  {
    try
    {
      CameraPosition localCameraPosition = zzapq.getCameraPosition();
  ...
  public final IndoorBuilding getFocusedBuilding()
  {
    try
    {
      Object localObject = zzapq.getFocusedBuilding();
      if (localObject != null)
      {
        localObject = new IndoorBuilding((zzj)localObject);
  ...
  public final Location getMyLocation()
  {
    try
    {
      Location localLocation = zzapq.getMyLocation();
  ...
  public final Projection getProjection()
  {
    try
    {
      Projection localProjection = new Projection(zzapq.getProjection());
  ...
  public final UiSettings getUiSettings()
  {
    try
    {
      ...
      UiSettings localUiSettings = zzapr;
  ...
  public final boolean isBuildingsEnabled()
  {
    try
    {
      boolean bool = zzapq.isBuildingsEnabled();
      return bool;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final boolean isIndoorEnabled()
  {
    try
    {
      boolean bool = zzapq.isIndoorEnabled();
      return bool;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final boolean isMyLocationEnabled()
  {
    try
    {
      boolean bool = zzapq.isMyLocationEnabled();
      return bool;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final boolean isTrafficEnabled()
  {
    try
    {
      boolean bool = zzapq.isTrafficEnabled();
      return bool;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final void moveCamera(CameraUpdate paramCameraUpdate)
  {
    try
    {
      zzapq.moveCamera(paramCameraUpdate.zzqe());
      return;
    }
    catch (RemoteException paramCameraUpdate)
    {
  ...
  public final void setBuildingsEnabled(boolean paramBoolean)
  {
    try
    {
      zzapq.setBuildingsEnabled(paramBoolean);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final void setContentDescription(String paramString)
  {
    try
    {
      zzapq.setContentDescription(paramString);
      return;
    }
  ...
  public final boolean setIndoorEnabled(boolean paramBoolean)
  {
    try
    {
      paramBoolean = zzapq.setIndoorEnabled(paramBoolean);
      return paramBoolean;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final void setInfoWindowAdapter(final InfoWindowAdapter paramInfoWindowAdapter)
  {
    ...
    zzapq.setInfoWindowAdapter(new zzd.zza()
    {
  ...
  public final void setLocationSource(final LocationSource paramLocationSource)
  {
    ...
    zzapq.setLocationSource(new ILocationSourceDelegate.zza()
    {
      public void activate(final zzi paramAnonymouszzi)
      {
  ...
  public final void setMyLocationEnabled(boolean paramBoolean)
  {
    try
    {
      zzapq.setMyLocationEnabled(paramBoolean);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final void setOnCameraChangeListener(final OnCameraChangeListener paramOnCameraChangeListener)
  {
    ...
    zzapq.setOnCameraChangeListener(new zzf.zza()
    {
  ...
  public final void setOnIndoorStateChangeListener(final OnIndoorStateChangeListener paramOnIndoorStateChangeListener)
  {
    ...
    zzapq.setOnIndoorStateChangeListener(new zzg.zza()
    {
  ...
  public final void setOnInfoWindowClickListener(final OnInfoWindowClickListener paramOnInfoWindowClickListener)
  {
    ...
    zzapq.setOnInfoWindowClickListener(new zzh.zza()
    {
  ...
  public final void setOnMapClickListener(final OnMapClickListener paramOnMapClickListener)
  {
    ...
    zzapq.setOnMapClickListener(new zzj.zza()
    {
  ...
  public final void setOnMapLoadedCallback(final OnMapLoadedCallback paramOnMapLoadedCallback)
  {
    ...
    zzapq.setOnMapLoadedCallback(new zzk.zza()
    {
  ...
  public final void setOnMapLongClickListener(final OnMapLongClickListener paramOnMapLongClickListener)
  {
    ...
    zzapq.setOnMapLongClickListener(new zzl.zza()
    {
  ...
  public final void setOnMarkerClickListener(final OnMarkerClickListener paramOnMarkerClickListener)
  {
    ...
    zzapq.setOnMarkerClickListener(new zzn.zza()
    {
  ...
  public final void setOnMarkerDragListener(final OnMarkerDragListener paramOnMarkerDragListener)
  {
    ...
    zzapq.setOnMarkerDragListener(new zzo.zza()
    {
  ...
  public final void setOnMyLocationButtonClickListener(final OnMyLocationButtonClickListener paramOnMyLocationButtonClickListener)
  {
    ...
    zzapq.setOnMyLocationButtonClickListener(new zzp.zza()
    {
  ...
  public final void setOnMyLocationChangeListener(final OnMyLocationChangeListener paramOnMyLocationChangeListener)
  {
    ...
    zzapq.setOnMyLocationChangeListener(new zzq.zza()
    {
  ...
  public final void setPadding(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    try
    {
      zzapq.setPadding(paramInt1, paramInt2, paramInt3, paramInt4);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final void setTrafficEnabled(boolean paramBoolean)
  {
    try
    {
      zzapq.setTrafficEnabled(paramBoolean);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  {
    if (paramBitmap != null) {}
    for (paramBitmap = zze.zzn(paramBitmap);; paramBitmap = null)
    {
      paramBitmap = (zze)paramBitmap;
      try
      {
        zzapq.snapshot(new zzv.zza()
        {
