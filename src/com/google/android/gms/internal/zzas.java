...
public class zzas
{
  ...
  public static void zza(String[] paramArrayOfString, int paramInt1, int paramInt2, PriorityQueue<zza> paramPriorityQueue)
  {
    ...
    {
      l1 = zza(zzaq.zzo(paramArrayOfString[(i - 1)]), zzaq.zzo(paramArrayOfString[(i + paramInt2 - 1)]), l1, l2, 16785407L);
  ...
  {
    long l = (zzaq.zzo(paramArrayOfString[paramInt1]) + 2147483647L) % 1073807359L;
    int i = paramInt1 + 1;
    while (i < paramInt1 + paramInt2)
    {
      l = (l * 16785407L % 1073807359L + (zzaq.zzo(paramArrayOfString[i]) + 2147483647L) % 1073807359L) % 1073807359L;
      i += 1;
    }
    return l;
  }
