...
{
  private static final Pattern zzRP = Pattern.compile("\\\\.");
  private static final Pattern zzRQ = Pattern.compile("[\\\\\"/\b\f\n\r\t]");
  
  public static String zzbt(String paramString)
  {
    Matcher localMatcher;
    Object localObject1;
    if (!TextUtils.isEmpty(paramString))
    {
      localMatcher = zzRQ.matcher(paramString);
      localObject1 = null;
  ...
  public static boolean zzd(Object paramObject1, Object paramObject2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          bool1 = zzd(((JSONObject)paramObject1).get(str), ((JSONObject)paramObject2).get(str));
          if (!bool1) {
            return false;
          }
        }
      ...
      try
      {
        bool3 = zzd(((JSONArray)paramObject1).get(i), ((JSONArray)paramObject2).get(i));
        bool1 = bool2;
        if (bool3) {
          i += 1;
        }
