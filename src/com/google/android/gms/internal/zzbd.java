...
{
  private final AdSize[] zzpe;
  private final String zzpf;
  
  public zzbd(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    for (zzpe = zzq(paramAttributeSet);; zzpe = zzq(str))
    {
      zzpf = paramContext.getString(R.styleable.AdsAttrs_adUnitId);
      if (!TextUtils.isEmpty(zzpf)) {
        return;
      }
  ...
  private static AdSize[] zzq(String paramString)
  {
