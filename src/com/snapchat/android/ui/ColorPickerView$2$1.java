  ...
  implements Animation.AnimationListener
{
  ...
  public final void onAnimationEnd(Animation paramAnimation)
  {
    ...
    paramAnimation = new TranslateAnimation((int)awf.a(-23.5F, a.a.getContext()), 0.0F, 0.0F, 0.0F);
    paramAnimation.setDuration(140L);
    paramAnimation.setFillAfter(true);
    ColorPickerView.d(a.a).startAnimation(paramAnimation);
    paramAnimation = new ColorPickerView.a(a.a, ColorPickerView.h(a.a).getWidth(), (int)awf.a(12.0F, a.a.getContext()), ColorPickerView.h(a.a));
    paramAnimation.setDuration(140L);
