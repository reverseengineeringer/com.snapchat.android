  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    String str = SignupFragment.m(a).getText().toString().trim();
    if (SignupFragment.i().a(paramView))
    {
      AlertDialogUtils.a(SignupFragment.s(a), a.getString(2131493227, new Object[] { paramView }));
      return;
    }
    Object localObject = (GregorianCalendar)GregorianCalendar.getInstance();
    ((GregorianCalendar)localObject).add(1, -13);
    if (!SignupFragment.o(a).before(localObject))
    {
      localObject = SignupFragment.i();
      if (!((auo)localObject).a(paramView))
      {
      ...
      AlertDialogUtils.a(2131493498, SignupFragment.s(a));
