  ...
  implements InvalidateCb
{
  ...
  public CircleVideoView(Context paramContext)
  {
    super(paramContext);
    if (isInEditMode()) {
      return;
  ...
  public CircleVideoView(Context paramContext, AttributeSet paramAttributeSet)
  {
...
/* Location:
 * Qualified Name:     com.addlive.view.CircleVideoView
