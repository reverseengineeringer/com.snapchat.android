...
public class ErrorUtil
{
  ...
  static
  {
    ...
    {
      System.err.println("Exception in ErrorUtil initializer: " + localException.getMessage());
  ...
  public static String getMessage(String paramString)
  {
    try
    {
      String str = messages.getString(paramString);
      return str;
    }
    catch (Exception localException) {}
    return paramString;
...
/* Location:
 * Qualified Name:     com.brightcove.player.util.ErrorUtil
