  ...
  extends AsyncTask<Void, Void, HashMap<String, String>>
{
  ...
  public bxd(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, List<Uri> paramList, String paramString6, Handler paramHandler, boolean paramBoolean)
  {
    a = paramContext;
    d = paramString1;
    e = paramString2;
  ...
  private HashMap<String, String> a(HttpClient paramHttpClient)
  {
    ...
    try
    {
      ...
      ((List)localObject).add(new BasicNameValuePair("bundle_identifier", bwa.d));
      ((List)localObject).add(new BasicNameValuePair("bundle_short_version", bwa.c));
      ((List)localObject).add(new BasicNameValuePair("bundle_version", bwa.b));
      ((List)localObject).add(new BasicNameValuePair("os_version", bwa.e));
      ((List)localObject).add(new BasicNameValuePair("oem", bwa.g));
      ((List)localObject).add(new BasicNameValuePair("model", bwa.f));
  ...
  private HashMap<String, String> b(HttpClient paramHttpClient)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        ((List)localObject1).add(new BasicNameValuePair("bundle_identifier", bwa.d));
        ((List)localObject1).add(new BasicNameValuePair("bundle_short_version", bwa.c));
        ((List)localObject1).add(new BasicNameValuePair("bundle_version", bwa.b));
        ((List)localObject1).add(new BasicNameValuePair("os_version", bwa.e));
        ((List)localObject1).add(new BasicNameValuePair("oem", bwa.g));
        ((List)localObject1).add(new BasicNameValuePair("model", bwa.f));
      ...
      catch (UnsupportedEncodingException paramHttpClient)
      {
        ...
        if (n < i.size())
        {
          ...
          if (n == i.size() - 1)
          {
            ...
            localbxk.a("attachment" + n, (String)localObject2, (InputStream)localObject1, "application/octet-stream", bool);
            n += 1;
          }
        }
        else
        {
          ...
          if (j != null)
          {
            ...
            ((HttpPut)localObject1).setEntity(localbxk);
      ...
      catch (ClientProtocolException paramHttpClient)
      {
        ...
        localHttpPost.setEntity(localbxk);
  ...
  private HashMap<String, String> c(HttpClient paramHttpClient)
  {
    ...
    ((StringBuilder)localObject).append(d + bxl.a(j));
    if (m != -1) {
