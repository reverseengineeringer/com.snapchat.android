...
public final class bwb
{
  ...
  public static void a(Context paramContext, String paramString, final bwc parambwc)
  {
    ...
    if (i == 1)
    {
      ...
      if (parambwc != null) {
        paramContext = Boolean.valueOf(Boolean.valueOf(paramString.booleanValue() | parambwc.a()).booleanValue() | false);
      }
      if (!paramContext.booleanValue())
      {
        ...
        if (paramContext != null)
        {
          ...
          paramContext.setTitle(bwj.a(parambwc, 0));
          paramContext.setMessage(bwj.a(parambwc, 1));
          paramContext.setNegativeButton(bwj.a(parambwc, 2), new DialogInterface.OnClickListener()
          {
            public final void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
            {
              bwb.a(localWeakReference);
              bwb.a(a, bool);
            }
          });
          paramContext.setNeutralButton(bwj.a(parambwc, 3), new DialogInterface.OnClickListener()
          {
            public final void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
            {
              ...
              bwb.a(a, parambwc, bool);
            }
          });
          paramContext.setPositiveButton(bwj.a(parambwc, 4), new DialogInterface.OnClickListener()
          {
            public final void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
            {
              bwb.a(a, parambwc, bool);
      ...
      b(localWeakReference, parambwc, localBoolean.booleanValue());
      return;
    }
    if (i == 2)
    {
    ...
    b(parambwc, localBoolean.booleanValue());
  }
  ...
  public static void a(WeakReference<Context> paramWeakReference, bwc parambwc)
  {
    String[] arrayOfString = b();
    Object localObject1;
    int i;
  ...
  private static void b(bwc parambwc, boolean paramBoolean)
  {
    Thread.UncaughtExceptionHandler localUncaughtExceptionHandler;
    if ((bwa.b != null) && (bwa.d != null))
    {
      ...
      if ((localUncaughtExceptionHandler instanceof bwd)) {
        a = parambwc;
      }
    }
    else
    ...
    Thread.setDefaultUncaughtExceptionHandler(new bwd(localUncaughtExceptionHandler, parambwc, paramBoolean));
  }
  
  private static void b(WeakReference<Context> paramWeakReference, final bwc parambwc, boolean paramBoolean)
  {
    Object localObject;
    if (paramWeakReference != null)
    {
  ...
  private static String[] b()
  {
    if (bwa.a != null)
    {
      new StringBuilder("Looking for exceptions in: ").append(bwa.a);
      File localFile = new File(bwa.a + "/");
