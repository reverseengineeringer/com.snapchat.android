...
{
  private static HashMap<cgi, cjs> a;
  private final cgi b;
  private final cgm c;
  
  private cjs(cgi paramcgi, cgm paramcgm)
  {
    if ((paramcgi == null) || (paramcgm == null)) {
  ...
  /* Error */
  public static cjs a(cgi paramcgi, cgm paramcgm)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 29	cjs:a	Ljava/util/HashMap;
    //   6: ifnonnull +47 -> 53
    //   9: new 31	java/util/HashMap
    //   12: dup
    //   13: bipush 7
    //   15: invokespecial 34	java/util/HashMap:<init>	(I)V
    //   18: putstatic 29	cjs:a	Ljava/util/HashMap;
    //   21: aconst_null
    //   22: astore_2
    //   23: aload_2
    //   24: astore_3
    ...
    //   33: aload_0
    //   34: aload_1
    //   35: invokespecial 36	cjs:<init>	(Lcgi;Lcgm;)V
    //   38: astore_3
    //   39: getstatic 29	cjs:a	Ljava/util/HashMap;
    //   42: aload_0
    //   43: aload_3
    ...
    //   51: aload_3
    //   52: areturn
    //   53: getstatic 29	cjs:a	Ljava/util/HashMap;
    //   56: aload_0
