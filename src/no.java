...
public final class no
{
  ...
  private static final no sInstance = new no();
  ...
  private no(EasyMetric.EasyMetricFactory paramEasyMetricFactory)
  {
  ...
  {
    boolean bool = ajx.ab();
    EasyMetric localEasyMetric = EasyMetric.EasyMetricFactory.b("SNAP_CAPTURED_TO_PREVIEW");
    if (paramBoolean) {}
    for (String str = "video";; str = "image")
    {
      mSnapCaptureMetric = localEasyMetric.a("type", str).a("filtersEnabled", Boolean.valueOf(bool)).b();
      return;
    }
  }
