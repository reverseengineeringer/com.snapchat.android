  ...
  extends bpq
{
  ...
  private static int a(ContentResolver paramContentResolver, Uri paramUri)
  {
    ...
    //   0: aload_0
    //   1: aload_1
    //   2: getstatic 17	bpz:b	[Ljava/lang/String;
    //   5: aconst_null
    //   6: aconst_null
    //   7: aconst_null
  ...
  {
    parambqh = d;
    return ("content".equals(parambqh.getScheme())) && ("media".equals(parambqh.getAuthority()));
  }
  ...
  public final bqj.a b(bqh parambqh)
  {
    ...
    for (;;)
    {
      if ((i != 0) || (localObject != bpz.a.c)) {
        break label170;
      }
      return new bqj.a(null, c(parambqh), bqe.d.b, k);
      i = 0;
      break;
      label132:
      if ((m <= be) && (n <= bf)) {
    ...
    a(h, i, e, f, localOptions, parambqh);
    if (i != 0) {
      if (localObject == bpz.a.c) {
        i = j;
      }
    }
    for (localObject = MediaStore.Video.Thumbnails.getThumbnail(localContentResolver, l, i, localOptions);; localObject = MediaStore.Images.Thumbnails.getThumbnail(localContentResolver, l, d, localOptions))
    {
      ...
      return new bqj.a((Bitmap)localObject, null, bqe.d.b, k);
      i = d;
      break;
    }
    label290:
