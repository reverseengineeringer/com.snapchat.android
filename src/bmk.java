...
public final class bmk
{
  ...
  private bmk(boolean paramBoolean1, boolean paramBoolean2, int paramInt1, int paramInt2, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5, int paramInt3, int paramInt4, boolean paramBoolean6, boolean paramBoolean7, String paramString)
  {
    c = paramBoolean1;
    d = paramBoolean2;
    e = paramInt1;
  ...
  public static bmk a(bmv parambmv)
  {
    boolean bool5 = false;
    int i6 = -1;
    int i5 = -1;
    ...
    while (i7 < i13)
    {
      Object localObject2 = parambmv.a(i7);
      String str1 = parambmv.b(i7);
      int i8;
      ...
      for (;;)
      {
        ...
        {
          i6 = bnu.b((String)localObject2, -1);
          i8 = i2;
        }
        else if ("s-maxage".equalsIgnoreCase(str2))
        {
          i5 = bnu.b((String)localObject2, -1);
          i8 = i2;
        }
        ...
        {
          i4 = bnu.b((String)localObject2, Integer.MAX_VALUE);
          i8 = i2;
        }
        else if ("min-fresh".equalsIgnoreCase(str2))
        {
          i3 = bnu.b((String)localObject2, -1);
          i8 = i2;
        }
    ...
    if (i1 == 0) {}
    for (parambmv = null;; parambmv = (bmv)localObject1) {
      return new bmk(bool1, bool5, i6, i5, bool7, bool6, bool4, i4, i3, bool3, bool2, parambmv);
    }
  }
