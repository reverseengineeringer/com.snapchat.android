...
public final class fm
{
  ...
  public final fl a()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 40	fm:a	Ljava/io/InputStream;
    //   4: ifnonnull +13 -> 17
    ...
    //   17: new 49	fp$e
    //   20: dup
    //   21: invokespecial 50	fp$e:<init>	()V
    //   24: astore 5
    //   26: aload_0
    //   27: getfield 22	fm:b	Ljava/lang/Integer;
    //   30: astore 6
    //   32: aload_0
    //   33: getfield 24	fm:c	Ljava/lang/Integer;
    //   36: astore 7
    //   38: aload_0
    //   39: getfield 32	fm:g	Z
    //   42: istore 4
    //   44: aload 5
    //   46: aload 6
    //   48: putfield 53	fp$e:u	Ljava/lang/Integer;
    //   51: aload 5
    //   53: aload 7
    //   55: putfield 56	fp$e:v	Ljava/lang/Integer;
    //   58: aload 7
    //   60: ifnull +217 -> 277
    //   63: iload 4
    //   65: ifeq +212 -> 277
    ...
    //   89: putfield 73	fp$e:w	Ljava/lang/Float;
    //   92: aload 5
    //   94: aload_0
    //   95: getfield 30	fm:f	Z
    //   98: putfield 76	fp$e:x	Z
    //   101: aload_0
    //   102: getfield 26	fm:d	Landroid/graphics/ColorFilter;
    //   105: ifnull +16 -> 121
    //   108: aload 5
    //   110: getfield 79	fp$e:c	Landroid/graphics/Paint;
    //   113: aload_0
    //   114: getfield 26	fm:d	Landroid/graphics/ColorFilter;
    //   117: invokevirtual 85	android/graphics/Paint:setColorFilter	(Landroid/graphics/ColorFilter;)Landroid/graphics/ColorFilter;
    //   120: pop
    //   121: aload_0
    //   122: getfield 28	fm:e	Landroid/graphics/ColorFilter;
    //   125: ifnull +16 -> 141
    //   128: aload 5
    //   130: getfield 87	fp$e:g	Landroid/graphics/Paint;
    //   133: aload_0
    //   134: getfield 28	fm:e	Landroid/graphics/ColorFilter;
    //   137: invokevirtual 85	android/graphics/Paint:setColorFilter	(Landroid/graphics/ColorFilter;)Landroid/graphics/ColorFilter;
    //   140: pop
    //   141: aload_0
    //   142: getfield 40	fm:a	Ljava/io/InputStream;
    ...
    //   155: dup
    //   156: aload_0
    //   157: getfield 40	fm:a	Ljava/io/InputStream;
    //   160: invokespecial 98	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   163: putfield 40	fm:a	Ljava/io/InputStream;
    //   166: aload_0
    //   167: getfield 40	fm:a	Ljava/io/InputStream;
    //   170: iconst_4
    ...
    //   177: astore 6
    //   179: aload_0
    //   180: getfield 40	fm:a	Ljava/io/InputStream;
    //   183: aload 6
    //   185: iconst_0
    //   186: iconst_2
    ...
    //   200: istore_3
    //   201: aload_0
    //   202: getfield 40	fm:a	Ljava/io/InputStream;
    ...
    //   231: dup
    //   232: aload_0
    //   233: getfield 40	fm:a	Ljava/io/InputStream;
    //   236: invokespecial 114	java/util/zip/GZIPInputStream:<init>	(Ljava/io/InputStream;)V
    //   239: putfield 40	fm:a	Ljava/io/InputStream;
    //   242: new 116	org/xml/sax/InputSource
    //   245: dup
    //   246: aload_0
    //   247: getfield 40	fm:a	Ljava/io/InputStream;
    //   250: invokespecial 117	org/xml/sax/InputSource:<init>	(Ljava/io/InputStream;)V
    //   253: aload 5
    //   255: invokestatic 122	fp:a	(Lorg/xml/sax/InputSource;Lfp$e;)Lfl;
    //   258: astore 5
    //   260: aload_0
    //   261: getfield 34	fm:h	Z
    //   264: ifeq +10 -> 274
    //   267: aload_0
    //   268: getfield 40	fm:a	Ljava/io/InputStream;
    //   271: invokevirtual 125	java/io/InputStream:close	()V
    //   274: aload 5
    //   276: areturn
    //   277: aload 5
    //   279: aconst_null
    //   280: putfield 73	fp$e:w	Ljava/lang/Float;
    //   283: goto -191 -> 92
    //   286: astore 5
    //   288: aload_0
    //   289: getfield 34	fm:h	Z
    //   292: ifeq +10 -> 302
    //   295: aload_0
    //   296: getfield 40	fm:a	Ljava/io/InputStream;
    ...
    //   310: dup
    //   311: aload 5
    //   313: invokespecial 130	fo:<init>	(Ljava/lang/Throwable;)V
    //   316: athrow
    //   317: astore 6
    //   319: goto -17 -> 302
    //   322: astore 6
