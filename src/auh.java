...
public final class auh
{
  ...
  public static final ExecutorService THUMBNAIL_EXECUTOR = new ThreadPoolExecutor(3, 3, 10L, TimeUnit.SECONDS, a(), new auh.a("Thumbnail", 10));
  
  static
  {
    NETWORK_EXECUTOR = new ThreadPoolExecutor(3, 64, 10L, TimeUnit.SECONDS, a(), new auh.a("Network", 0));
    MISCELLANEOUS_EXECUTOR = new ThreadPoolExecutor(3, 64, 10L, TimeUnit.SECONDS, a(), new auh.a("Misc", 10));
    HIGH_PRIORITY_EXECUTOR = new ThreadPoolExecutor(3, 64, 10L, TimeUnit.SECONDS, a(), new auh.a("HighPriority", -2));
    SERIAL_BACKGROUND_EXECUTOR = new ThreadPoolExecutor(1, Integer.MAX_VALUE, 30L, TimeUnit.SECONDS, a(), new auh.a("Serial", 0));
    MEDIA_PLAYER_SERIAL_EXECUTOR = new ThreadPoolExecutor(1, Integer.MAX_VALUE, 30L, TimeUnit.SECONDS, a(), new auh.a("MediaPlayer", -2));
    SERIAL_EXECUTOR_FOR_LOGGING = new ThreadPoolExecutor(1, Integer.MAX_VALUE, 2L, TimeUnit.SECONDS, a(), new auh.a("Logging", 10));
    SERIAL_EXECUTOR_FOR_DEBUGGING = new ThreadPoolExecutor(1, Integer.MAX_VALUE, 10L, TimeUnit.SECONDS, a(), new auh.a("Debugging", -1));
    SERIAL_EXECUTOR_FOR_SQL_WRITE_OPS = new ThreadPoolExecutor(1, 1, 0L, TimeUnit.MILLISECONDS, a(), new auh.a("SqlWriteOps", 10));
  }
