...
final class bpo
{
  ...
  static int a(Resources paramResources, bpg parambpg)
  {
    if ((e != 0) || (d == null)) {
      return e;
    }
    ...
    if (localList.size() == 2)
    {
      parambpg = (String)localList.get(0);
      return paramResources.getIdentifier((String)localList.get(1), parambpg, str);
    }
  ...
  static Resources a(Context paramContext, bpg parambpg)
  {
    if ((e != 0) || (d == null)) {
  ...
  static bos a(Context paramContext)
  {
    try
    {
      Class.forName("bly");
      bpc localbpc = new bpc(paramContext);
      return localbpc;
    }
    catch (ClassNotFoundException localClassNotFoundException) {}
    return new bpn(paramContext);
  }
  ...
  static String a(bol parambol)
  {
    return a(parambol, "");
  }
  
  static String a(bol parambol, String paramString)
  {
  ...
  static String a(bpg parambpg)
  {
    parambpg = a(parambpg, a);
    a.setLength(0);
    return parambpg;
  }
  
  static String a(bpg parambpg, StringBuilder paramStringBuilder)
  {
    if (f != null)
    {
      ...
      if (parambpg.c())
      {
        paramStringBuilder.append("resize:").append(h).append('x').append(parambpg.i);
        paramStringBuilder.append('\n');
      }
      if (!parambpg.j) {
        break label274;
    ...
    for (;;)
    {
      ...
      while (i < j)
      {
        paramStringBuilder.append(((bpm)g.get(i)).b());
        paramStringBuilder.append('\n');
        i += 1;
      }
      if (d != null)
