  ...
  implements boz
{
  ...
  {
    return new bow.a(paramcax, paramBoolean);
  }
  
  public final bol a(caw paramcaw, boolean paramBoolean)
  {
    return new bow.b(paramcaw, paramBoolean);
  }
    ...
    implements bok
  {
    ...
    a(cax paramcax, boolean paramBoolean)
    {
      a = paramcax;
      c = new bos(a);
      b = paramBoolean;
    ...
    implements bol
  {
    ...
    b(caw paramcaw, boolean paramBoolean)
    {
      a = paramcaw;
      d = paramBoolean;
