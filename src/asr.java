...
public final class asr
{
  ...
  public static void a(@cgb Activity paramActivity)
  {
    ...
    Timber.c("ActivityLauncher", "Launching LoginAndSignupActivity [%s]", new Object[] { localIntent.toString() });
    paramActivity.finish();
  }
  
  public static void a(@cgb Context paramContext)
  {
    try
    {
