  ...
  implements View.OnTouchListener
{
  ...
  public vn(Context paramContext, RelativeLayout paramRelativeLayout, CameraDecor.CameraDecorInterface paramCameraDecorInterface)
  {
    ...
    paramRelativeLayout = paramCameraDecorInterface.inflate(2130968596, paramRelativeLayout, true);
    r = paramContext.getResources().getString(2131493338, new Object[] { baj.a(Emoji.HAPPY_PERSON_RAISING_ONE_HAND) });
    o = new ScaleGestureDetector(paramContext, new vn.b((byte)0));
    p = new GestureDetector(paramContext, new vn.a((byte)0));
    ...
    f.setOnTouchListener(new asv(f));
    i.setOnTouchListener(new asv(i));
    g.setOnTouchListener(new asv(g));
    ...
    if ((localObject != null) && (((ajv)localObject).h() > 0))
    {
      ...
      bgp.a(new Runnable()
      {
        public final void run()
        {
          ...
          m.setText(vn.a(vn.this));
        }
      });
      localObject = akc.b().e().iterator();
      i4 = 0;
      i5 = 0;
      i1 = 0;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        bgp.a(new Runnable()
        {
          public final void run()
          {
            vn.a(g, 2130837535, 2130837534, a);
          }
        });
        return;
        if (i2 == i3) {
