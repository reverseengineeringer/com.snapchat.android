...
public final class bma$1
  implements Runnable
{
  public bma$1(bma parambma, Context paramContext) {}
  ...
  public final void run()
  {
    ...
    //   1: istore_2
    //   2: aload_0
    //   3: getfield 16	bma$1:b	Lbma;
    //   6: astore 7
    //   8: aload_0
    //   9: getfield 18	bma$1:a	Landroid/content/Context;
    //   12: astore 6
    //   14: aload 6
    //   16: ldc 29
    //   18: iconst_0
    ...
    //   31: aload 5
    //   33: ifnonnull +7 -> 40
    //   36: invokestatic 43	bmf:b	()V
    //   39: return
    //   40: aload 6
    //   42: invokestatic 46	bma:a	(Landroid/content/Context;)I
    //   45: istore_1
    //   46: aload 9
    //   48: ldc 48
    //   50: iconst_m1
    ...
    //   84: dup
    //   85: aload 5
    //   87: invokespecial 68	bmg:<init>	(Ljava/lang/String;)V
    //   90: astore 8
    ...
    //   107: aload 8
    //   109: aload 6
    //   111: invokestatic 74	bma:a	(Lbmg;Ljava/io/FileReader;)Lbme;
    //   114: astore 8
    //   116: aload 8
    //   118: ifnonnull +84 -> 202
    //   121: aload 6
    //   123: invokestatic 79	bmd:a	(Ljava/io/Closeable;)V
    //   126: return
    //   127: astore 5
    //   129: aload_0
    //   130: getfield 16	bma$1:b	Lbma;
    //   133: getfield 82	bma:b	Ljava/lang/Thread$UncaughtExceptionHandler;
    //   136: ifnull +363 -> 499
    //   139: aload_0
    //   140: getfield 16	bma$1:b	Lbma;
    //   143: getfield 82	bma:b	Ljava/lang/Thread$UncaughtExceptionHandler;
    ...
    //   223: ifne +76 -> 299
    //   226: aload 6
    //   228: invokestatic 79	bmd:a	(Ljava/io/Closeable;)V
    //   231: return
    //   232: iload_2
    //   233: istore_1
    //   234: aload 6
    ...
    //   301: astore 5
    //   303: aload 7
    //   305: getfield 135	bma:a	Ljava/util/List;
    ...
    //   352: dup
    //   353: aload 8
    //   355: getfield 157	bme:b	Ljava/lang/String;
    //   358: invokespecial 158	bmb$a:<init>	(Ljava/lang/String;)V
    //   361: astore 10
    //   363: aload 6
    //   365: astore 5
    //   367: new 160	bmb
    //   370: dup
    //   371: aload 10
    //   373: getfield 162	bmb$a:a	Ljava/lang/String;
    //   376: iconst_0
    //   377: invokespecial 165	bmb:<init>	(Ljava/lang/String;B)V
    //   380: astore 11
    //   382: aload 6
    //   384: astore 5
    //   386: aload 10
    //   388: getfield 168	bmb$a:b	[Ljava/lang/StackTraceElement;
    //   391: ifnull +17 -> 408
    //   394: aload 6
    //   396: astore 5
    //   398: aload 11
    //   400: aload 10
    //   402: getfield 168	bmb$a:b	[Ljava/lang/StackTraceElement;
    //   405: invokevirtual 172	bmb:setStackTrace	([Ljava/lang/StackTraceElement;)V
    //   408: aload 6
    //   410: astore 5
    ...
    //   427: aload 6
    //   429: astore 5
    //   431: invokestatic 183	bmf:a	()V
    //   434: aload 6
    //   436: astore 5
    //   438: aload 9
    //   440: aload 8
    //   442: getfield 157	bme:b	Ljava/lang/String;
    //   445: aload 11
    ...
    //   466: aload 6
    //   468: invokestatic 79	bmd:a	(Ljava/io/Closeable;)V
    //   471: return
    //   472: aload 6
    //   474: invokestatic 79	bmd:a	(Ljava/io/Closeable;)V
    //   477: return
    //   478: aload 5
    //   480: invokestatic 79	bmd:a	(Ljava/io/Closeable;)V
    //   483: aload 6
    //   485: athrow
    //   486: astore 6
    //   488: goto -10 -> 478
    ...
    //   361	40	10	locala	bmb.a
    //   380	66	11	localbmb	bmb
    // Exception table:
    //   from	to	target	type
