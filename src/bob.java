...
final class bob
{
  ...
  static Map<Class<?>, boe> a(Object paramObject)
  {
    ...
    if (!((Map)localObject).isEmpty())
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        boe localboe = new boe(paramObject, (Method)localEntry.getValue());
        localHashMap.put(localEntry.getKey(), localboe);
      }
    }
    return localHashMap;
  }
  ...
  private static void a(Class<?> paramClass)
  {
    ...
    if (i < j)
    {
      ...
      {
        if (!localMethod.isAnnotationPresent(boh.class)) {
          break label271;
        }
      ...
      for (;;)
      {
        ...
        break;
        label271:
        if (localMethod.isAnnotationPresent(bog.class))
        {
          localObject1 = localMethod.getParameterTypes();
  ...
  static Map<Class<?>, Set<bod>> b(Object paramObject)
  {
    Object localObject = paramObject.getClass();
    HashMap localHashMap = new HashMap();
    ...
    if (!((Map)localObject).isEmpty())
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        while (localIterator.hasNext()) {
          localHashSet.add(new bod(paramObject, (Method)localIterator.next()));
        }
