...
{
  public static Bitmap a(int paramInt1, int paramInt2, @chd View... paramVarArgs)
  {
    if (paramVarArgs.length == 0) {
      throw new IllegalArgumentException("Specify at least one View to draw.");
    }
    Object localObject2 = awo.a().a(paramInt1, paramInt2, Bitmap.Config.ARGB_8888);
    Object localObject1 = localObject2;
    if (localObject2 == null) {
      localObject1 = avp.a(paramInt1, paramInt2, Bitmap.Config.ARGB_8888);
    }
  ...
  public static Bitmap a(Context paramContext, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    Bitmap localBitmap = avp.a(paramInt2, paramInt3, Bitmap.Config.ARGB_8888);
