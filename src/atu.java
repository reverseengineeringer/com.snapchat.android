  ...
  implements View.OnTouchListener
{
  ...
  public atu(View paramView)
  {
    this(paramView, false);
  }
  
  public atu(View paramView, byte paramByte)
  {
    this(paramView, true);
  }
  
  private atu(View paramView, boolean paramBoolean)
  {
    this(paramView, paramBoolean, awi.a());
  }
  
  private atu(View paramView, boolean paramBoolean, bp parambp)
  {
    ...
    mSpring.a(new bi()
    {
      public final void a(bj paramAnonymousbj)
      {
        if (atu.a(atu.this))
        {
          ...
          float f2 = (float)d.a;
          atu.a(atu.this, (f1 - 1.0F) * f2 + 1.0F);
        }
      }
    });
  }
