  ...
  implements btm, Runnable
{
  ...
  public btn(bqu parambqu, URL paramURL)
  {
    this(parambqu, paramURL, (byte)0);
  }
  
  private btn(bqu parambqu, URL paramURL, byte paramByte)
  {
    g = parambqu;
    d = paramURL;
    j = 50;
  ...
  public final void run()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 61	btn:h	Z
    //   4: ifne +160 -> 164
    //   7: aload_0
    //   8: getfield 59	btn:a	Landroid/os/ConditionVariable;
    //   11: invokevirtual 180	android/os/ConditionVariable:block	()V
    //   14: aload_0
    //   15: getfield 57	btn:f	Landroid/os/ConditionVariable;
    //   18: invokevirtual 180	android/os/ConditionVariable:block	()V
    //   21: aload_0
    //   22: getfield 61	btn:h	Z
    //   25: istore_1
    //   26: iload_1
    //   27: ifne +137 -> 164
    //   30: aload_0
    //   31: invokespecial 182	btn:a	()J
    //   34: lconst_0
    //   35: lcmp
    //   36: ifle +10 -> 46
    //   39: aload_0
    //   40: invokespecial 182	btn:a	()J
    //   43: invokestatic 188	java/lang/Thread:sleep	(J)V
    //   46: aload_0
    //   47: invokestatic 48	java/lang/System:currentTimeMillis	()J
    //   50: putfield 50	btn:e	J
    //   53: aload_0
    //   54: invokespecial 190	btn:b	()Ljava/net/HttpURLConnection;
    //   57: astore_2
    //   58: aload_2
    //   59: ifnonnull +12 -> 71
    //   62: aload_0
    //   63: iconst_1
    //   64: putfield 61	btn:h	Z
    //   67: invokestatic 158	btd:e	()V
    //   70: return
    //   71: aload_0
    //   72: getfield 63	btn:i	Ljava/lang/Object;
    //   75: astore_3
    //   76: aload_3
    //   77: monitorenter
    //   78: aload_0
    //   79: getfield 40	btn:c	Ljava/util/List;
    //   82: astore 4
    //   84: aload_0
    //   85: new 37	java/util/LinkedList
    //   88: dup
    //   89: invokespecial 38	java/util/LinkedList:<init>	()V
    //   92: putfield 40	btn:c	Ljava/util/List;
    //   95: aload_0
    //   96: getfield 57	btn:f	Landroid/os/ConditionVariable;
    //   99: invokevirtual 193	android/os/ConditionVariable:close	()V
    //   102: aload_3
    //   103: monitorexit
    //   104: aload_0
    //   105: getfield 71	btn:g	Lbqu;
    //   108: aload 4
    //   110: invokestatic 198	bpz:a	(Lbqu;Ljava/util/List;)Lbpz;
    //   113: astore_3
    //   114: aload_3
    //   115: ifnonnull +33 -> 148
    //   118: aload_0
    //   119: iconst_1
    //   120: putfield 61	btn:h	Z
    //   123: invokestatic 158	btd:e	()V
    //   126: return
    //   127: astore_2
    ...
    //   148: aload_2
    //   149: aload_3
    //   150: getfield 206	bpz:a	Lorg/json/JSONObject;
    //   153: invokestatic 208	btn:a	(Ljava/net/HttpURLConnection;Lorg/json/JSONObject;)Z
    //   156: pop
    //   157: goto -157 -> 0
    //   160: astore_2
    //   161: goto -115 -> 46
