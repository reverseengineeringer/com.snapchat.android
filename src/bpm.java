  ...
  implements Runnable
{
  ...
  private static final bqj w = new bqj()
  {
    public final boolean a(bqh paramAnonymousbqh)
    {
      return true;
    }
    
    public final bqj.a b(bqh paramAnonymousbqh)
    {
      throw new IllegalStateException("Unrecognized type of request: " + paramAnonymousbqh);
    }
  };
  ...
  private bpm(bqe parambqe, bps parambps, bpn parambpn, bql parambql, bpk parambpk, bqj parambqj)
  {
    b = parambqe;
    c = parambps;
    d = parambpn;
  ...
  private static Bitmap a(final List<bqn> paramList, Bitmap paramBitmap)
  {
    int i2 = paramList.size();
    int i1 = 0;
    while (i1 < i2)
    {
      bqn localbqn = (bqn)paramList.get(i1);
      Bitmap localBitmap;
      try
      {
        localBitmap = localbqn.a();
        if (localBitmap != null) {
          break label154;
        }
        paramBitmap = new StringBuilder("Transformation ").append(localbqn.b()).append(" returned null after ").append(i1).append(" previous transformation(s).\n\nTransformation list:\n");
        paramList = paramList.iterator();
        while (paramList.hasNext()) {
          paramBitmap.append(((bqn)paramList.next()).b()).append('\n');
        }
  ...
  static bpm a(bqe parambqe, bps parambps, bpn parambpn, bql parambql, bpk parambpk)
  {
    bqh localbqh = b;
    List localList = e;
    int i1 = 0;
    ...
    while (i1 < i2)
    {
      bqj localbqj = (bqj)localList.get(i1);
      if (localbqj.a(localbqh)) {
        return new bpm(parambqe, parambps, parambpn, parambql, parambpk, localbqj);
      }
      i1 += 1;
    }
    return new bpm(parambqe, parambps, parambpn, parambql, parambpk, w);
  }
  ...
  private Bitmap c()
  {
    ...
    //   1: astore 18
    //   3: aload_0
    //   4: getfield 117	bpm:h	I
    //   7: invokestatic 225	bqa:a	(I)Z
    //   10: ifeq +78 -> 88
    //   13: aload_0
    //   14: getfield 93	bpm:d	Lbpn;
    //   17: aload_0
    //   18: getfield 103	bpm:f	Ljava/lang/String;
    ...
    //   34: ifnull +54 -> 88
    //   37: aload_0
    //   38: getfield 95	bpm:e	Lbql;
    //   41: invokevirtual 234	bql:a	()V
    //   44: aload_0
    //   45: getstatic 238	bqe$d:a	Lbqe$d;
    //   48: putfield 240	bpm:o	Lbqe$d;
    //   51: aload 20
    //   53: astore 19
    //   55: aload_0
    //   56: getfield 89	bpm:b	Lbqe;
    //   59: getfield 243	bqe:o	Z
    //   62: ifeq +23 -> 85
    //   65: ldc -11
    //   67: ldc -9
    //   69: aload_0
    //   70: getfield 107	bpm:g	Lbqh;
    //   73: invokevirtual 249	bqh:a	()Ljava/lang/String;
    //   76: ldc -5
    //   78: invokestatic 256	bqp:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   81: aload 20
    //   83: astore 19
    //   85: aload 19
    //   87: areturn
    //   88: aload_0
    //   89: getfield 107	bpm:g	Lbqh;
    //   92: astore 19
    //   94: aload_0
    //   95: getfield 128	bpm:r	I
    //   98: ifne +683 -> 781
    //   101: getstatic 261	bqb:c	Lbqb;
    //   104: getfield 263	bqb:d	I
    //   107: istore 5
    //   109: aload 19
    //   111: iload 5
    //   113: putfield 265	bqh:c	I
    //   116: aload_0
    //   117: getfield 123	bpm:j	Lbqj;
    //   120: aload_0
    //   121: getfield 107	bpm:g	Lbqh;
    //   124: invokevirtual 268	bqj:b	(Lbqh;)Lbqj$a;
    //   127: astore 20
    //   129: aload 20
    //   131: ifnull +163 -> 294
    //   134: aload_0
    //   135: aload 20
    //   137: getfield 271	bqj$a:a	Lbqe$d;
    //   140: putfield 240	bpm:o	Lbqe$d;
    //   143: aload_0
    //   144: aload 20
    //   146: getfield 272	bqj$a:d	I
    //   149: putfield 274	bpm:q	I
    //   152: aload 20
    //   154: getfield 276	bqj$a:b	Landroid/graphics/Bitmap;
    //   157: astore 19
    //   159: aload 19
    //   161: astore 18
    //   163: aload 19
    ...
    //   168: aload 20
    //   170: getfield 279	bqj$a:c	Ljava/io/InputStream;
    //   173: astore 20
    //   175: aload_0
    //   176: getfield 107	bpm:g	Lbqh;
    //   179: astore 18
    //   181: new 281	bpy
    //   184: dup
    //   185: aload 20
    //   187: invokespecial 284	bpy:<init>	(Ljava/io/InputStream;)V
    //   190: astore 21
    //   192: aload 21
    //   194: ldc_w 285
    //   197: invokevirtual 288	bpy:a	(I)J
    //   200: lstore 14
    //   202: aload 18
    //   204: invokestatic 291	bqj:d	(Lbqh;)Landroid/graphics/BitmapFactory$Options;
    //   207: astore 19
    //   209: aload 19
    //   211: invokestatic 294	bqj:a	(Landroid/graphics/BitmapFactory$Options;)Z
    //   214: istore 16
    //   216: aload 21
    //   218: invokestatic 297	bqp:c	(Ljava/io/InputStream;)Z
    //   221: istore 17
    //   223: aload 21
    //   225: lload 14
    //   227: invokevirtual 300	bpy:a	(J)V
    //   230: iload 17
    //   232: ifeq +558 -> 790
    //   235: aload 21
    //   237: invokestatic 303	bqp:b	(Ljava/io/InputStream;)[B
    //   240: astore 21
    //   242: iload 16
    //   244: ifeq +32 -> 276
    //   247: aload 21
    ...
    //   258: pop
    //   259: aload 18
    //   261: getfield 310	bqh:h	I
    //   264: aload 18
    //   266: getfield 311	bqh:i	I
    //   269: aload 19
    //   271: aload 18
    //   273: invokestatic 314	bqj:a	(IILandroid/graphics/BitmapFactory$Options;Lbqh;)V
    //   276: aload 21
    //   278: iconst_0
    //   279: aload 21
    //   281: arraylength
    ...
    //   287: astore 18
    //   289: aload 20
    //   291: invokestatic 316	bqp:a	(Ljava/io/InputStream;)V
    //   294: aload 18
    //   296: astore 19
    //   298: aload 18
    //   300: ifnull -215 -> 85
    //   303: aload_0
    //   304: getfield 89	bpm:b	Lbqe;
    //   307: getfield 243	bqe:o	Z
    //   310: ifeq +17 -> 327
    //   313: ldc -11
    //   315: ldc -9
    //   317: aload_0
    //   318: getfield 107	bpm:g	Lbqh;
    //   321: invokevirtual 249	bqh:a	()Ljava/lang/String;
    //   324: invokestatic 319	bqp:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   327: aload_0
    //   328: getfield 95	bpm:e	Lbql;
    //   331: aload 18
    //   333: iconst_2
    //   334: invokevirtual 322	bql:a	(Landroid/graphics/Bitmap;I)V
    //   337: aload_0
    //   338: getfield 107	bpm:g	Lbqh;
    //   341: astore 19
    //   343: aload 19
    //   345: invokevirtual 324	bqh:d	()Z
    //   348: ifne +11 -> 359
    //   351: aload 19
    //   353: invokevirtual 326	bqh:e	()Z
    //   356: ifeq +512 -> 868
    //   359: iconst_1
    //   360: istore 5
    //   362: iload 5
    ...
    //   369: astore 19
    //   371: aload_0
    //   372: getfield 274	bpm:q	I
    //   375: ifeq -290 -> 85
    //   378: getstatic 68	bpm:t	Ljava/lang/Object;
    //   381: astore 21
    //   383: aload 21
    //   385: monitorenter
    //   386: aload_0
    //   387: getfield 107	bpm:g	Lbqh;
    //   390: invokevirtual 324	bqh:d	()Z
    //   393: ifne +14 -> 407
    //   396: aload 18
    //   398: astore 20
    //   400: aload_0
    //   401: getfield 274	bpm:q	I
    //   404: ifeq +288 -> 692
    //   407: aload_0
    //   408: getfield 107	bpm:g	Lbqh;
    //   411: astore 19
    //   413: aload_0
    //   414: getfield 274	bpm:q	I
    //   417: istore 11
    //   419: aload 18
    ...
    //   447: astore 20
    //   449: aload 19
    //   451: invokevirtual 324	bqh:d	()Z
    //   454: ifeq +592 -> 1046
    //   457: aload 19
    //   459: getfield 310	bqh:h	I
    //   462: istore 12
    //   464: aload 19
    //   466: getfield 311	bqh:i	I
    //   469: istore 13
    //   471: aload 19
    //   473: getfield 340	bqh:m	F
    //   476: fstore_3
    //   477: fload_3
    //   478: fconst_0
    //   479: fcmpl
    //   480: ifeq +27 -> 507
    //   483: aload 19
    //   485: getfield 342	bqh:p	Z
    //   488: ifeq +386 -> 874
    //   491: aload 20
    //   493: fload_3
    //   494: aload 19
    //   496: getfield 344	bqh:n	F
    //   499: aload 19
    //   501: getfield 346	bqh:o	F
    //   504: invokevirtual 350	android/graphics/Matrix:setRotate	(FFF)V
    //   507: aload 19
    //   509: getfield 352	bqh:j	Z
    //   512: ifeq +423 -> 935
    //   515: iload 12
    //   517: i2f
    //   518: iload 5
    ...
    //   585: iload 12
    //   587: iload 13
    //   589: invokestatic 360	bpm:a	(ZIIII)Z
    //   592: ifeq +498 -> 1090
    //   595: aload 20
    //   597: fload_3
    //   598: fload 4
    ...
    //   661: astore 20
    //   663: aload_0
    //   664: getfield 89	bpm:b	Lbqe;
    //   667: getfield 243	bqe:o	Z
    //   670: ifeq +22 -> 692
    //   673: ldc -11
    //   675: ldc_w 377
    //   678: aload_0
    //   679: getfield 107	bpm:g	Lbqh;
    //   682: invokevirtual 249	bqh:a	()Ljava/lang/String;
    //   685: invokestatic 319	bqp:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   688: aload 19
    //   690: astore 20
    //   692: aload 20
    //   694: astore 18
    //   696: aload_0
    //   697: getfield 107	bpm:g	Lbqh;
    //   700: invokevirtual 326	bqh:e	()Z
    //   703: ifeq +53 -> 756
    //   706: aload_0
    //   707: getfield 107	bpm:g	Lbqh;
    //   710: getfield 379	bqh:g	Ljava/util/List;
    //   713: aload 20
    //   715: invokestatic 381	bpm:a	(Ljava/util/List;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    //   718: astore 19
    //   720: aload 19
    //   722: astore 18
    //   724: aload_0
    //   725: getfield 89	bpm:b	Lbqe;
    //   728: getfield 243	bqe:o	Z
    //   731: ifeq +25 -> 756
    //   734: ldc -11
    //   736: ldc_w 377
    //   739: aload_0
    //   740: getfield 107	bpm:g	Lbqh;
    //   743: invokevirtual 249	bqh:a	()Ljava/lang/String;
    //   746: ldc_w 383
    //   749: invokestatic 256	bqp:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   752: aload 19
    //   754: astore 18
    //   756: aload 21
    //   758: monitorexit
    ...
    //   765: ifnull -680 -> 85
    //   768: aload_0
    //   769: getfield 95	bpm:e	Lbql;
    //   772: aload 18
    //   774: iconst_3
    //   775: invokevirtual 322	bql:a	(Landroid/graphics/Bitmap;I)V
    //   778: aload 18
    //   780: areturn
    //   781: aload_0
    //   782: getfield 121	bpm:i	I
    //   785: istore 5
    //   787: goto -678 -> 109
    //   790: iload 16
    //   792: ifeq +36 -> 828
    ...
    //   803: pop
    //   804: aload 18
    //   806: getfield 310	bqh:h	I
    //   809: aload 18
    //   811: getfield 311	bqh:i	I
    //   814: aload 19
    //   816: aload 18
    //   818: invokestatic 314	bqj:a	(IILandroid/graphics/BitmapFactory$Options;Lbqh;)V
    //   821: aload 21
    //   823: lload 14
    //   825: invokevirtual 300	bpy:a	(J)V
    //   828: aload 21
    //   830: aconst_null
    //   831: aload 19
    ...
    //   858: astore 18
    //   860: aload 20
    //   862: invokestatic 316	bqp:a	(Ljava/io/InputStream;)V
    //   865: aload 18
    //   867: athrow
    //   868: iconst_0
    //   869: istore 5
    ...
    //   973: iload 12
    //   975: iload 13
    //   977: invokestatic 360	bpm:a	(ZIIII)Z
    //   980: ifeq +121 -> 1101
    //   983: aload 20
    //   985: fload_3
    //   986: fload_3
    ...
    //   1027: iload 12
    //   1029: iload 13
    //   1031: invokestatic 360	bpm:a	(ZIIII)Z
    //   1034: ifeq +12 -> 1046
    //   1037: aload 20
    //   1039: fload_3
    //   1040: fload 4
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          s = i2;
          if (b.o) {
            bqp.a("Hunter", "removed", b.a(), bqp.a(this, "from "));
          }
          return;
        }
      }
  ...
  public final void run()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 107	bpm:g	Lbqh;
    //   4: astore_1
    //   5: aload_1
    //   6: getfield 440	bqh:d	Landroid/net/Uri;
    //   9: ifnull +112 -> 121
    //   12: aload_1
    //   13: getfield 440	bqh:d	Landroid/net/Uri;
    ...
    //   22: astore_1
    //   23: getstatic 71	bpm:u	Ljava/lang/ThreadLocal;
    ...
    //   66: aload_0
    //   67: getfield 89	bpm:b	Lbqe;
    //   70: getfield 243	bqe:o	Z
    //   73: ifeq +15 -> 88
    //   76: ldc -11
    //   78: ldc_w 481
    //   81: aload_0
    //   82: invokestatic 484	bqp:a	(Lbpm;)Ljava/lang/String;
    //   85: invokestatic 319	bqp:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   88: aload_0
    //   89: aload_0
    //   90: invokespecial 486	bpm:c	()Landroid/graphics/Bitmap;
    //   93: putfield 488	bpm:m	Landroid/graphics/Bitmap;
    //   96: aload_0
    //   97: getfield 488	bpm:m	Landroid/graphics/Bitmap;
    //   100: ifnonnull +32 -> 132
    //   103: aload_0
    //   104: getfield 91	bpm:c	Lbps;
    //   107: aload_0
    //   108: invokevirtual 493	bps:b	(Lbpm;)V
    ...
    //   120: return
    //   121: aload_1
    //   122: getfield 496	bqh:e	I
    //   125: invokestatic 502	java/lang/Integer:toHexString	(I)Ljava/lang/String;
    //   128: astore_1
    //   129: goto -106 -> 23
    //   132: aload_0
    //   133: getfield 91	bpm:c	Lbps;
    //   136: astore_1
    //   137: aload_1
    //   138: getfield 504	bps:i	Landroid/os/Handler;
    //   141: aload_1
    //   142: getfield 504	bps:i	Landroid/os/Handler;
    //   145: iconst_4
    //   146: aload_0
    ...
    //   157: astore_1
    //   158: aload_1
    //   159: getfield 514	bpt$b:a	Z
    //   162: ifeq +13 -> 175
    //   165: aload_1
    //   166: getfield 516	bpt$b:b	I
    //   169: sipush 504
    //   172: if_icmpeq +8 -> 180
    //   175: aload_0
    //   176: aload_1
    //   177: putfield 518	bpm:p	Ljava/lang/Exception;
    //   180: aload_0
    //   181: getfield 91	bpm:c	Lbps;
    //   184: aload_0
    //   185: invokevirtual 493	bps:b	(Lbpm;)V
    ...
    //   199: aload_0
    //   200: aload_1
    //   201: putfield 518	bpm:p	Ljava/lang/Exception;
    //   204: aload_0
    //   205: getfield 91	bpm:c	Lbps;
    //   208: aload_0
    //   209: invokevirtual 520	bps:a	(Lbpm;)V
    ...
    //   223: aload_0
    //   224: aload_1
    //   225: putfield 518	bpm:p	Ljava/lang/Exception;
    //   228: aload_0
    //   229: getfield 91	bpm:c	Lbps;
    //   232: aload_0
    //   233: invokevirtual 520	bps:a	(Lbpm;)V
    ...
    //   254: astore_2
    //   255: aload_0
    //   256: getfield 95	bpm:e	Lbql;
    //   259: astore_3
    //   260: new 525	bqm
    //   263: dup
    //   264: aload_3
    //   265: getfield 527	bql:b	Lbpn;
    //   268: invokeinterface 529 1 0
    //   273: aload_3
    //   274: getfield 527	bql:b	Lbpn;
    //   277: invokeinterface 530 1 0
    //   282: aload_3
    //   283: getfield 533	bql:d	J
    //   286: aload_3
    //   287: getfield 535	bql:e	J
    //   290: aload_3
    //   291: getfield 537	bql:f	J
    //   294: aload_3
    //   295: getfield 539	bql:g	J
    //   298: aload_3
    //   299: getfield 541	bql:h	J
    //   302: aload_3
    //   303: getfield 543	bql:i	J
    //   306: aload_3
    //   307: getfield 545	bql:j	J
    //   310: aload_3
    //   311: getfield 547	bql:k	J
    //   314: aload_3
    //   315: getfield 549	bql:l	I
    //   318: aload_3
    //   319: getfield 551	bql:m	I
    //   322: aload_3
    //   323: getfield 553	bql:n	I
    //   326: invokestatic 559	java/lang/System:currentTimeMillis	()J
    //   329: invokespecial 562	bqm:<init>	(IIJJJJJJJJIIIJ)V
    //   332: astore_3
    ...
    //   401: aload 4
    //   403: aload_3
    //   404: getfield 585	bqm:b	I
    //   407: i2f
    //   408: aload_3
    //   409: getfield 580	bqm:a	I
    //   412: i2f
    //   413: fdiv
    //   414: ldc_w 588
    //   417: fmul
    ...
    //   655: putfield 518	bpm:p	Ljava/lang/Exception;
    //   658: aload_0
    //   659: getfield 91	bpm:c	Lbps;
    //   662: aload_0
    //   663: invokevirtual 493	bps:b	(Lbpm;)V
    ...
    //   677: aload_0
    //   678: aload_1
    //   679: putfield 518	bpm:p	Ljava/lang/Exception;
    //   682: aload_0
    //   683: getfield 91	bpm:c	Lbps;
    //   686: aload_0
    //   687: invokevirtual 493	bps:b	(Lbpm;)V
    ...
    //   157	20	1	localb	bpt.b
    //   198	3	1	locala	bqc.a
