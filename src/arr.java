  ...
  extends RecyclerView.s
{
  ...
  public arr(View paramView)
  {
    super(paramView);
    k = null;
  }
  
  public arr(arp paramarp, Context paramContext, View paramView)
  {
    super(paramView);
    n = paramarp;
    k = paramContext;
    l = ((ImageView)paramView.findViewById(2131362593));
    paramarp = (FrameLayout)paramView.findViewById(2131362591);
    o = new arr.a();
    paramarp.setOnClickListener(o);
  }
    ...
    implements View.OnClickListener
  {
    ...
    public final void onClick(View paramView)
    {
      ...
      //   1: monitorenter
      //   2: aload_0
      //   3: getfield 50	arr$a:u	Larr;
      //   6: getfield 97	arr:n	Larp;
      //   9: getfield 102	arp:c	Larq;
      //   12: astore_1
      //   13: aload_0
      //   14: getfield 50	arr$a:u	Larr;
      //   17: getfield 105	arr:m	I
      //   20: istore_2
      //   21: aload_1
      //   22: getfield 110	arq:b	[Z
      //   25: iload_2
      //   26: baload
      //   27: istore_3
      //   28: iload_3
      ...
      //   34: return
      //   35: aload_0
      //   36: getfield 50	arr$a:u	Larr;
      //   39: getfield 112	arr:l	Landroid/widget/ImageView;
      //   42: ifnull -10 -> 32
      //   45: aload_0
      //   46: getfield 50	arr$a:u	Larr;
      //   49: getfield 112	arr:l	Landroid/widget/ImageView;
      //   52: invokevirtual 118	android/widget/ImageView:getDrawable	()Landroid/graphics/drawable/Drawable;
      //   55: ifnull -23 -> 32
      //   58: aload_0
      //   59: getfield 50	arr$a:u	Larr;
      //   62: iconst_0
      //   63: invokevirtual 121	arr:a	(Z)V
      //   66: aload_0
      //   67: getfield 89	arr$a:t	Ljava/util/concurrent/atomic/AtomicInteger;
      //   70: iconst_0
      ...
      //   79: putfield 65	arr$a:x	Ljava/lang/Boolean;
      //   82: aload_0
      //   83: aload_0
      //   84: getfield 50	arr$a:u	Larr;
      //   87: getfield 127	arr:a	Landroid/view/View;
      //   90: ldc -128
      //   92: invokevirtual 134	android/view/View:findViewById	(I)Landroid/view/View;
      //   95: checkcast 114	android/widget/ImageView
      //   98: putfield 136	arr$a:a	Landroid/widget/ImageView;
      //   101: aload_0
      //   102: getfield 136	arr$a:a	Landroid/widget/ImageView;
      ...
      //   119: pop
      //   120: aload_0
      //   121: getfield 136	arr$a:a	Landroid/widget/ImageView;
      //   124: iconst_0
      ...
      //   148: putfield 155	arr$a:b	Landroid/animation/ObjectAnimator;
      //   151: aload_0
      //   152: getfield 155	arr$a:b	Landroid/animation/ObjectAnimator;
      //   155: ldc2_w 156
      //   158: invokevirtual 161	android/animation/ObjectAnimator:setDuration	(J)Landroid/animation/ObjectAnimator;
      //   161: pop
      //   162: aload_0
      //   163: aload_0
      //   164: getfield 50	arr$a:u	Larr;
      //   167: getfield 127	arr:a	Landroid/view/View;
      //   170: ldc -94
      //   172: invokevirtual 134	android/view/View:findViewById	(I)Landroid/view/View;
      //   175: checkcast 114	android/widget/ImageView
      //   178: putfield 164	arr$a:c	Landroid/widget/ImageView;
      //   181: aload_0
      //   182: getfield 164	arr$a:c	Landroid/widget/ImageView;
      ...
      //   199: pop
      //   200: aload_0
      //   201: getfield 164	arr$a:c	Landroid/widget/ImageView;
      //   204: iconst_0
      ...
      //   228: putfield 166	arr$a:d	Landroid/animation/ObjectAnimator;
      //   231: aload_0
      //   232: getfield 166	arr$a:d	Landroid/animation/ObjectAnimator;
      //   235: ldc2_w 156
      ...
      //   262: putfield 168	arr$a:e	Landroid/animation/ObjectAnimator;
      //   265: aload_0
      //   266: getfield 168	arr$a:e	Landroid/animation/ObjectAnimator;
      //   269: ldc2_w 156
      //   272: invokevirtual 161	android/animation/ObjectAnimator:setDuration	(J)Landroid/animation/ObjectAnimator;
      //   275: pop
      //   276: aload_0
      //   277: aload_0
      //   278: getfield 50	arr$a:u	Larr;
      //   281: getfield 127	arr:a	Landroid/view/View;
      //   284: ldc -87
      //   286: invokevirtual 134	android/view/View:findViewById	(I)Landroid/view/View;
      //   289: checkcast 114	android/widget/ImageView
      //   292: putfield 171	arr$a:f	Landroid/widget/ImageView;
      //   295: aload_0
      //   296: getfield 171	arr$a:f	Landroid/widget/ImageView;
      ...
      //   311: pop
      //   312: aload_0
      //   313: getfield 171	arr$a:f	Landroid/widget/ImageView;
      //   316: iconst_0
      //   317: invokevirtual 145	android/widget/ImageView:setVisibility	(I)V
      //   320: aload_0
      //   321: aload_0
      //   322: getfield 50	arr$a:u	Larr;
      //   325: getfield 127	arr:a	Landroid/view/View;
      //   328: ldc -84
      //   330: invokevirtual 134	android/view/View:findViewById	(I)Landroid/view/View;
      //   333: checkcast 114	android/widget/ImageView
      //   336: putfield 174	arr$a:g	Landroid/widget/ImageView;
      //   339: aload_0
      //   340: getfield 174	arr$a:g	Landroid/widget/ImageView;
      ...
      //   357: pop
      //   358: aload_0
      //   359: getfield 174	arr$a:g	Landroid/widget/ImageView;
      //   362: iconst_0
      ...
      //   386: putfield 176	arr$a:h	Landroid/animation/ObjectAnimator;
      //   389: aload_0
      //   390: getfield 176	arr$a:h	Landroid/animation/ObjectAnimator;
      //   393: ldc2_w 156
      ...
      //   421: putfield 178	arr$a:i	Landroid/animation/ObjectAnimator;
      //   424: aload_0
      //   425: getfield 178	arr$a:i	Landroid/animation/ObjectAnimator;
      //   428: ldc2_w 156
      //   431: invokevirtual 161	android/animation/ObjectAnimator:setDuration	(J)Landroid/animation/ObjectAnimator;
      //   434: pop
      //   435: aload_0
      //   436: aload_0
      //   437: getfield 50	arr$a:u	Larr;
      //   440: getfield 127	arr:a	Landroid/view/View;
      //   443: ldc -77
      //   445: invokevirtual 134	android/view/View:findViewById	(I)Landroid/view/View;
      //   448: checkcast 114	android/widget/ImageView
      //   451: putfield 181	arr$a:j	Landroid/widget/ImageView;
      //   454: aload_0
      //   455: getfield 181	arr$a:j	Landroid/widget/ImageView;
      //   458: sipush 65280
      //   461: invokevirtual 184	android/widget/ImageView:setBackgroundColor	(I)V
      //   464: aload_0
      //   465: getfield 181	arr$a:j	Landroid/widget/ImageView;
      //   468: iconst_0
      //   469: invokevirtual 145	android/widget/ImageView:setVisibility	(I)V
      //   472: aload_0
      //   473: getfield 181	arr$a:j	Landroid/widget/ImageView;
      ...
      //   483: aload_0
      //   484: aload_0
      //   485: getfield 181	arr$a:j	Landroid/widget/ImageView;
      //   488: ldc -64
      //   490: iconst_2
      ...
      //   508: putfield 202	arr$a:k	Landroid/animation/ObjectAnimator;
      //   511: aload_0
      //   512: getfield 202	arr$a:k	Landroid/animation/ObjectAnimator;
      //   515: ldc2_w 156
      //   518: invokevirtual 161	android/animation/ObjectAnimator:setDuration	(J)Landroid/animation/ObjectAnimator;
      //   521: pop
      //   522: aload_0
      //   523: aload_0
      //   524: getfield 181	arr$a:j	Landroid/widget/ImageView;
      //   527: ldc -64
      //   529: iconst_2
      ...
      //   547: putfield 204	arr$a:l	Landroid/animation/ObjectAnimator;
      //   550: aload_0
      //   551: getfield 204	arr$a:l	Landroid/animation/ObjectAnimator;
      //   554: ldc2_w 156
      //   557: invokevirtual 161	android/animation/ObjectAnimator:setDuration	(J)Landroid/animation/ObjectAnimator;
      //   560: pop
      //   561: aload_0
      //   562: getfield 70	arr$a:m	Landroid/animation/AnimatorSet;
      //   565: aload_0
      //   566: getfield 204	arr$a:l	Landroid/animation/ObjectAnimator;
      ...
      //   572: pop
      //   573: aload_0
      //   574: getfield 72	arr$a:n	Landroid/animation/AnimatorSet;
      //   577: aload_0
      //   578: getfield 166	arr$a:d	Landroid/animation/ObjectAnimator;
      ...
      //   584: pop
      //   585: aload_0
      //   586: getfield 74	arr$a:o	Landroid/animation/AnimatorSet;
      //   589: aload_0
      //   590: getfield 168	arr$a:e	Landroid/animation/ObjectAnimator;
      ...
      //   596: aload_0
      //   597: getfield 166	arr$a:d	Landroid/animation/ObjectAnimator;
      ...
      //   603: pop
      //   604: aload_0
      //   605: getfield 76	arr$a:p	Landroid/animation/AnimatorSet;
      //   608: aload_0
      //   609: getfield 176	arr$a:h	Landroid/animation/ObjectAnimator;
      ...
      //   615: pop
      //   616: aload_0
      //   617: getfield 78	arr$a:q	Landroid/animation/AnimatorSet;
      //   620: iconst_2
      //   621: anewarray 215	android/animation/Animator
      //   624: dup
      //   625: iconst_0
      //   626: aload_0
      //   627: getfield 178	arr$a:i	Landroid/animation/ObjectAnimator;
      //   630: aastore
      //   631: dup
      //   632: iconst_1
      //   633: aload_0
      //   634: getfield 155	arr$a:b	Landroid/animation/ObjectAnimator;
      //   637: aastore
      //   638: invokevirtual 219	android/animation/AnimatorSet:playTogether	([Landroid/animation/Animator;)V
      //   641: aload_0
      //   642: getfield 80	arr$a:r	Landroid/animation/AnimatorSet;
      //   645: aload_0
      //   646: getfield 202	arr$a:k	Landroid/animation/ObjectAnimator;
      ...
      //   652: aload_0
      //   653: getfield 204	arr$a:l	Landroid/animation/ObjectAnimator;
      ...
      //   659: pop
      //   660: aload_0
      //   661: getfield 82	arr$a:s	Landroid/animation/AnimatorSet;
      //   664: aload_0
      //   665: getfield 202	arr$a:k	Landroid/animation/ObjectAnimator;
      ...
      //   671: pop
      //   672: aload_0
      //   673: getfield 72	arr$a:n	Landroid/animation/AnimatorSet;
      //   676: new 11	arr$a$1
      //   679: dup
      //   680: aload_0
      //   681: invokespecial 222	arr$a$1:<init>	(Larr$a;)V
      //   684: invokevirtual 226	android/animation/AnimatorSet:addListener	(Landroid/animation/Animator$AnimatorListener;)V
      //   687: aload_0
      //   688: getfield 74	arr$a:o	Landroid/animation/AnimatorSet;
      //   691: new 13	arr$a$2
      //   694: dup
      //   695: aload_0
      //   696: invokespecial 227	arr$a$2:<init>	(Larr$a;)V
      //   699: invokevirtual 226	android/animation/AnimatorSet:addListener	(Landroid/animation/Animator$AnimatorListener;)V
      //   702: aload_0
      //   703: getfield 78	arr$a:q	Landroid/animation/AnimatorSet;
      //   706: new 15	arr$a$3
      //   709: dup
      //   710: aload_0
      //   711: invokespecial 228	arr$a$3:<init>	(Larr$a;)V
      //   714: invokevirtual 226	android/animation/AnimatorSet:addListener	(Landroid/animation/Animator$AnimatorListener;)V
      //   717: aload_0
      //   718: getfield 72	arr$a:n	Landroid/animation/AnimatorSet;
      //   721: invokevirtual 231	android/animation/AnimatorSet:start	()V
      //   724: aload_0
      //   725: getfield 70	arr$a:m	Landroid/animation/AnimatorSet;
      //   728: invokevirtual 231	android/animation/AnimatorSet:start	()V
      //   731: aload_0
      //   732: getfield 50	arr$a:u	Larr;
      //   735: getfield 112	arr:l	Landroid/widget/ImageView;
      ...
      //   766: putfield 61	arr$a:v	Ljava/lang/Boolean;
      //   769: aload_1
      //   770: ifnull -738 -> 32
      //   773: aload_1
      ...
      //   795: putfield 63	arr$a:w	Ljava/lang/Boolean;
      ...
      //   812: invokestatic 269	bbo:a	()Lcom/squareup/otto/Bus;
      //   815: new 271	bcg
      //   818: dup
      //   819: ldc_w 273
      //   822: invokespecial 274	bcg:<init>	(Ljava/lang/String;)V
      //   825: invokevirtual 279	com/squareup/otto/Bus:a	(Ljava/lang/Object;)V
      //   828: invokestatic 284	aph:a	()Laph;
      //   831: aload_0
      //   832: getfield 50	arr$a:u	Larr;
      //   835: getfield 287	arr:k	Landroid/content/Context;
      //   838: aload_1
      ...
      //   852: invokevirtual 297	aph:a	(Landroid/content/Context;I[B)I
      //   855: pop
      //   856: goto -824 -> 32
      //   859: astore_1
      //   860: aload_0
