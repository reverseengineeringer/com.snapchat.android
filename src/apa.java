  ...
  extends AlertDialog
{
  ...
  public apa(Context paramContext, String paramString1, String paramString2, int paramInt)
  {
    super(paramContext);
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    setButton(-1, mContext.getString(2131493368), new DialogInterface.OnClickListener()
    {
      ...
      {
        ((InputMethodManager)apa.a(apa.this).getSystemService("input_method")).hideSoftInputFromWindow(localEditText.getWindowToken(), 0);
    ...
    localEditText.setOnEditorActionListener(new TextView.OnEditorActionListener()
    {
      public final boolean onEditorAction(TextView paramAnonymousTextView, int paramAnonymousInt, KeyEvent paramAnonymousKeyEvent)
      {
        ...
        {
          ((InputMethodManager)apa.a(apa.this).getSystemService("input_method")).hideSoftInputFromWindow(paramAnonymousTextView.getWindowToken(), 0);
